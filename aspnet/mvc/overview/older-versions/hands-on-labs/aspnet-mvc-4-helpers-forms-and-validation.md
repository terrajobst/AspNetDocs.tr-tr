...
1. [<span data-ttu-id="6f6b9-139">Store Yöneticisi denetleyicisi ve onun dizini görünümünü oluşturma</span><span class="sxs-lookup"><span data-stu-id="6f6b9-139">Creating the Store Manager controller and its Index view</span></span>](#Exercise1)
...
<span data-ttu-id="6f6b9-152">Bu görevde, adlı yeni bir denetleyici oluşturacaksınız **StoreManagerController** CRUD işlemlerini desteklemek için.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-152">In this task, you will create a new controller called **StoreManagerController** to support CRUD operations.</span></span>
...
2. <span data-ttu-id="6f6b9-161">Yeni bir denetleyici ekleyeceksiniz.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-161">Add a new controller.</span></span> <span data-ttu-id="6f6b9-162">Bunu yapmak için sağ **denetleyicileri** klasör Çözüm Gezgini'nde, seçme içinde **Ekle** ardından **denetleyicisi** komutu.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-162">To do this, right-click the **Controllers** folder within the Solution Explorer, select **Add** and then the **Controller** command.</span></span> <span data-ttu-id="6f6b9-163">Değişiklik **denetleyicisi** **adı** için **StoreManagerController** seçeneği emin **boşokuma/yazmaeylemleriileMVCdenetleyicisi**seçilir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-163">Change the **Controller** **Name** to **StoreManagerController** and make sure the option **MVC controller with empty read/write actions** is selected.</span></span> <span data-ttu-id="6f6b9-164">**Ekle**'yi tıklatın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-164">Click **Add**.</span></span>
    ...
    <span data-ttu-id="6f6b9-166">*Denetleyici Ekle iletişim kutusu*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-166">*Add Controller Dialog*</span></span>
...
<span data-ttu-id="6f6b9-215">*Albümleri listeyi gözden geçireceğiniz metin kesilmiş değil*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-215">*Browsing the list of Albums with not truncated text*</span></span>
...
2. <span data-ttu-id="6f6b9-230">StoreManager'ın dizini görünümünü açın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-230">Open StoreManager's Index View.</span></span> <span data-ttu-id="6f6b9-231">Bunu yapmak için Çözüm Gezgini'nde genişletin **görünümleri** klasörü, ardından **StoreManager** açın **Index.cshtml** dosya.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-231">To do this, in the Solution Explorer expand the **Views** folder, then the **StoreManager** and open the **Index.cshtml** file.</span></span>
...
2. <span data-ttu-id="6f6b9-242">Proje giriş sayfası başlatır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-242">The project starts in the Home page.</span></span> <span data-ttu-id="6f6b9-243">URL'yi **/StoreManager** bu uzun doğrulamak için metinleri **başlık** ve **sanatçının** sütun kesilir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-243">Change the URL to **/StoreManager** to verify that long texts in the **Title** and **Artist** column are truncated.</span></span>
    ...
    <span data-ttu-id="6f6b9-244">![Kesilmiş başlıklar ve sanatçıların adları](aspnet-mvc-4-helpers-forms-and-validation/_static/image6.png "kesilmiş başlıklar ve sanatçıların adları")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-244">![Truncated titles and artists names](aspnet-mvc-4-helpers-forms-and-validation/_static/image6.png "Truncated titles and artists names")</span></span>
...
2. <span data-ttu-id="6f6b9-275">Görünüm Ekle iletişim kutusunda, Görünüm adı olduğundan emin olun **Düzenle**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-275">In the Add View dialog, verify that the View Name is **Edit**.</span></span> <span data-ttu-id="6f6b9-276">Denetleyin **kesin türü belirtilmiş görünüm oluşturmak** onay kutusunu seçip **albüm (MvcMusicStore.Models)** gelen **görüntülemek veri sınıfı** açılır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-276">Check the **Create a strongly-typed view** checkbox and select **Album (MvcMusicStore.Models)** from the **View data class** drop-down.</span></span> <span data-ttu-id="6f6b9-277">Seçin **Düzenle** gelen **İskele şablon** açılır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-277">Select **Edit** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="6f6b9-278">Diğer alanları varsayılan değerlerine bırakın ve ardından **Ekle**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-278">Leave the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="6f6b9-280">*Düzenleme görünümü ekleme*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-280">*Adding an Edit view*</span></span>
...
1. <span data-ttu-id="6f6b9-319">Tuşuna **F5** uygulamayı çalıştırın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-319">Press **F5** to run the Application.</span></span>
...
1. <span data-ttu-id="6f6b9-358">Tuşuna **F5** uygulamayı çalıştırın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-358">Press **F5** to run the Application.</span></span>
...
3. <span data-ttu-id="6f6b9-381">Yeni oluşturduğunuz yeni albümü içerir StoreManager dizini görünümü yeniden yönlendirilen doğrulayın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-381">Verify that you get redirected to the StoreManager Index View that includes the new Album just created.</span></span>
    ...
    <span data-ttu-id="6f6b9-382">![Oluşturulan yeni albümü](aspnet-mvc-4-helpers-forms-and-validation/_static/image14.png "oluşturulan yeni albümü")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-382">![New Album Created](aspnet-mvc-4-helpers-forms-and-validation/_static/image14.png "New Album Created")</span></span>

    <span data-ttu-id="6f6b9-383">*Oluşturulan yeni albümü*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-383">*New Album Created*</span></span>

<a id="Exercise5"></a>

<a id="Exercise_5_Handling_Deletion"></a>
### <a name="exercise-5-handling-deletion"></a><span data-ttu-id="6f6b9-384">Alıştırma 5: İşleme silme</span><span class="sxs-lookup"><span data-stu-id="6f6b9-384">Exercise 5: Handling Deletion</span></span>

<span data-ttu-id="6f6b9-385">Albümleri silme olanağı henüz uygulanmadı.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-385">The ability to delete albums is not yet implemented.</span></span> <span data-ttu-id="6f6b9-386">Bu alıştırmada hakkında olacaktır budur.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-386">This is what this exercise will be about.</span></span> <span data-ttu-id="6f6b9-387">İçinde iki ayrı yöntemlerini kullanarak silme senaryosunu önce uygular gibi **StoreManagerController** sınıfı:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-387">Like before, you will implement the Delete scenario using two separate methods within the **StoreManagerController** class:</span></span>

1. <span data-ttu-id="6f6b9-388">Bir eylem yöntemi bir doğrulama formu görüntülenir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-388">One action method will display a confirmation form</span></span>
2. <span data-ttu-id="6f6b9-389">İkinci bir eylem yöntemi form gönderme işleyecek</span><span class="sxs-lookup"><span data-stu-id="6f6b9-389">A second action method will handle the form submission</span></span>

<a id="Ex5Task1"></a>

<a id="Task_1_-_Implementing_the_HTTP-GET_Delete_Action_Method"></a>
#### <a name="task-1---implementing-the-http-get-delete-action-method"></a><span data-ttu-id="6f6b9-390">Görev 1 - GET HTTP Delete eylem yöntemi uygulama</span><span class="sxs-lookup"><span data-stu-id="6f6b9-390">Task 1 - Implementing the HTTP-GET Delete Action Method</span></span>

<span data-ttu-id="6f6b9-391">Bu görevde, albüm bilgi almak için Delete eylem yöntemini HTTP GET sürümünü uygular.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-391">In this task, you will implement the HTTP-GET version of the Delete action method to retrieve the album's information.</span></span>

1. <span data-ttu-id="6f6b9-392">Açık **başlamak** çözüm bulunan **kaynak/Ex5-HandlingDeletion/başlangıç/** klasör.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-392">Open the **Begin** solution located at **Source/Ex5-HandlingDeletion/Begin/** folder.</span></span> <span data-ttu-id="6f6b9-393">Aksi takdirde kullanarak devam edebilir **son** çözüm elde edilen önceki egzersizini tamamlayarak.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-393">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="6f6b9-394">Sağlanan açtıysanız **başlamak** çözümü ihtiyaç duyacağınız bazı eksik NuGet paketlerini yüklemek devam etmeden önce.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-394">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="6f6b9-395">Bunu yapmak için tıklatın **proje** menü ve select **NuGet paketlerini Yönet**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-395">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="6f6b9-396">İçinde **NuGet paketlerini Yönet** iletişim kutusunda, tıklayın **geri** eksik paketleri indirmek için.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-396">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="6f6b9-397">Son olarak, tıklayarak çözüm oluşturun **derleme** | **Çözümü Derle**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-397">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="6f6b9-398">NuGet kullanmanın yararlarından biri, projenizdeki tüm kitaplıkları göndermeye proje boyutunu küçültmeyi gerekmemesidir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-398">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="6f6b9-399">NuGet güç araçları ile paket sürümlerini Packages.config dosyasında belirterek, gerekli tüm kitaplıkların projeyi Çalıştır ilk kez yüklemeye mümkün olmayacak.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-399">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="6f6b9-400">Bu laboratuvarda varolan bir çözümü açtıktan sonra aşağıdaki adımları çalıştırmanız gerekecek nedeni budur.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-400">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="6f6b9-401">Açık **StoreManagerController** sınıfı.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-401">Open **StoreManagerController** class.</span></span> <span data-ttu-id="6f6b9-402">Bunu yapmak için genişletme **denetleyicileri** klasörü ve çift **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-402">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
3. <span data-ttu-id="6f6b9-403">Silme denetleyici eylemi tam olarak önceki Store ayrıntıları denetleyici eylemini aynıdır: Bu sorgular **albüm** kullanarak veritabanı nesne **kimliği** döndürür ve URL içinde sağlanan uygun **görünümü**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-403">The Delete controller action is exactly the same as the previous Store Details controller action: it queries the **album** object from the database using the **id** provided in the URL and returns the appropriate **View**.</span></span> <span data-ttu-id="6f6b9-404">Bunu yapmak için HTTP GET değiştirin **Sil** eylem yöntemi kodu şu kodla:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-404">To do this, replace the HTTP-GET **Delete** action method code with the following:</span></span>

    <span data-ttu-id="6f6b9-405">(Kod parçacığını - *ASP.NET MVC 4 Yardımcılar ve formlar ve doğrulama - Ex5 işleme silme HTTP GET silme eylemi*)</span><span class="sxs-lookup"><span data-stu-id="6f6b9-405">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-GET Delete action*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample15.cs)]
4. <span data-ttu-id="6f6b9-406">İçinde sağ **Sil** eylem yöntemini seçip alt **Görünüm Ekle**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-406">Right-click inside the **Delete** action method and select **Add View**.</span></span> <span data-ttu-id="6f6b9-407">Bu Görünüm Ekle iletişim kutusu getirir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-407">This will bring up the Add View dialog.</span></span>
5. <span data-ttu-id="6f6b9-408">Görünüm Ekle iletişim kutusunda, Görünüm adı olduğundan emin olun **Sil**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-408">In the Add View dialog, verify that the View name is **Delete**.</span></span> <span data-ttu-id="6f6b9-409">Seçin **kesin türü belirtilmiş görünüm oluşturmak** seçeneğini işaretleyip **albüm (MvcMusicStore.Models)** gelen **Model sınıfı** açılır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-409">Select the **Create a strongly-typed view** option and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="6f6b9-410">Seçin **Sil** gelen **İskele şablon** açılır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-410">Select **Delete** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="6f6b9-411">Diğer alanları varsayılan değerlerine bırakın ve ardından **Ekle**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-411">Leave the other fields with their default value and then click **Add**.</span></span>

    <span data-ttu-id="6f6b9-412">![Delete görünüm ekleme](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "silme görünüm ekleme")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-412">![Adding a Delete View](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Adding a Delete View")</span></span>

    <span data-ttu-id="6f6b9-413">*Delete görünüm ekleme*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-413">*Adding a Delete View*</span></span>
6. <span data-ttu-id="6f6b9-414">Tüm alanları modelden Sil şablon gösterir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-414">The Delete template shows all the fields from the model.</span></span> <span data-ttu-id="6f6b9-415">Yalnızca albüm başlık gösterilir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-415">You will show only the album's title.</span></span> <span data-ttu-id="6f6b9-416">Bunu yapmak için görünümün içeriğini aşağıdaki kodla değiştirin:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-416">To do this, replace the content of the view with the following code:</span></span>
...
#### <a name="task-2---running-the-application"></a><span data-ttu-id="6f6b9-417">Görev 2 - uygulamayı çalıştırma</span><span class="sxs-lookup"><span data-stu-id="6f6b9-417">Task 2 - Running the Application</span></span>

<span data-ttu-id="6f6b9-418">Bu görevde, sınayacak **StoreManager** **Sil** görünüm sayfası onay silme form görüntüler.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-418">In this task, you will test that the **StoreManager** **Delete** View page displays a confirmation deletion form.</span></span>

1. <span data-ttu-id="6f6b9-419">Tuşuna **F5** uygulamayı çalıştırın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-419">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="6f6b9-420">Proje giriş sayfası başlatır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-420">The project starts in the Home page.</span></span> <span data-ttu-id="6f6b9-421">URL'yi **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-421">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="6f6b9-422">Tıklayarak silmek için bir albümü seçmek **Sil** ve yeni görüntüyü karşıya yüklendiğini doğrulayın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-422">Select one album to delete by clicking **Delete** and verify that the new view is uploaded.</span></span>

    <span data-ttu-id="6f6b9-423">![Albüm silme](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "albüm siliniyor")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-423">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "Deleting an Album")</span></span>

    <span data-ttu-id="6f6b9-424">*Albüm siliniyor*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-424">*Deleting an Album*</span></span>

<a id="Ex05Task3"></a>

<a id="Task_3-_Implementing_the_HTTP-POST_Delete_Action_Method"></a>
#### <a name="task-3--implementing-the-http-post-delete-action-method"></a><span data-ttu-id="6f6b9-425">Görev 3-HTTP-POST silme eylem yöntemi uygulama</span><span class="sxs-lookup"><span data-stu-id="6f6b9-425">Task 3- Implementing the HTTP-POST Delete Action Method</span></span>

<span data-ttu-id="6f6b9-426">Bu görevde, kullanıcı tıkladığında çağrılır Delete eylem yöntemini HTTP POST sürümünü gerçekleştireceksiniz **Sil** düğmesi.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-426">In this task, you will implement the HTTP-POST version of the Delete action method that will be invoked when a user clicks the **Delete** button.</span></span> <span data-ttu-id="6f6b9-427">Yöntemi, veritabanındaki albümü silmeniz gerekir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-427">The method should delete the album in the database.</span></span>

1. <span data-ttu-id="6f6b9-428">Gerekirse Visual Studio penceresine dönmek için tarayıcıyı kapatın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-428">Close the browser if needed, to return to the Visual Studio window.</span></span> <span data-ttu-id="6f6b9-429">Açık **StoreManagerController** sınıfı.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-429">Open **StoreManagerController** class.</span></span> <span data-ttu-id="6f6b9-430">Bunu yapmak için genişletme **denetleyicileri** klasörü ve çift **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-430">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
2. <span data-ttu-id="6f6b9-431">Değiştirin **HTTP POST Sil** eylem yöntemi kodu şu kodla:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-431">Replace **HTTP-POST Delete** action method code with the following:</span></span>

    <span data-ttu-id="6f6b9-432">(Kod parçacığını - *ASP.NET MVC 4 Yardımcılar ve formlar ve doğrulama - Ex5 işleme silme HTTP POST silme eylemi*)</span><span class="sxs-lookup"><span data-stu-id="6f6b9-432">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-POST Delete action*)</span></span>
...
#### <a name="task-4---running-the-application"></a><span data-ttu-id="6f6b9-433">Görev 4 - Uygulamayı çalıştırma</span><span class="sxs-lookup"><span data-stu-id="6f6b9-433">Task 4 - Running the Application</span></span>

<span data-ttu-id="6f6b9-434">Bu görevde, sınayacak **StoreManager silme** görünüm sayfası albüm silmenize olanak sağlar ve ardından StoreManager dizin görünümüne yeniden yönlendirir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-434">In this task, you will test that the **StoreManager Delete** View page lets you delete an Album and then redirects to the StoreManager Index View.</span></span>

1. <span data-ttu-id="6f6b9-435">Tuşuna **F5** uygulamayı çalıştırın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-435">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="6f6b9-436">Proje giriş sayfası başlatır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-436">The project starts in the Home page.</span></span> <span data-ttu-id="6f6b9-437">URL'yi **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-437">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="6f6b9-438">Tıklayarak silmek için bir albümü seçmek **silin.**</span><span class="sxs-lookup"><span data-stu-id="6f6b9-438">Select one album to delete by clicking **Delete.**</span></span> <span data-ttu-id="6f6b9-439">Silme işlemini onaylamak **Sil** düğmesi:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-439">Confirm the deletion by clicking **Delete** button:</span></span>

    <span data-ttu-id="6f6b9-440">![Albüm silme](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "albüm siliniyor")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-440">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "Deleting an Album")</span></span>

    <span data-ttu-id="6f6b9-441">*Albüm siliniyor*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-441">*Deleting an Album*</span></span>
3. <span data-ttu-id="6f6b9-442">İçinde görünmediğinden albümü silindiğini doğrulayın **dizin** sayfası.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-442">Verify that the album was deleted since it does not appear in the **Index** page.</span></span>

<a id="Exercise6"></a>

<a id="Exercise_6_Adding_Validation"></a>
### <a name="exercise-6-adding-validation"></a><span data-ttu-id="6f6b9-443">Alıştırma 6: Doğrulama Ekleme</span><span class="sxs-lookup"><span data-stu-id="6f6b9-443">Exercise 6: Adding Validation</span></span>

<span data-ttu-id="6f6b9-444">Şu anda prosedürleriniz var oluşturma ve düzenleme form doğrulama herhangi bir türden gerçekleştirmeyin.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-444">Currently, the Create and Edit forms you have in place do not perform any kind of validation.</span></span> <span data-ttu-id="6f6b9-445">Fiyat alanında harflerini yazın veya gerekli alanın boş kullanıcı ayrılsa erişmenizi sağlayacak ilk hata veritabanından olacaktır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-445">If the user leaves a required field blank or type letters in the price field, the first error you will get will be from the database.</span></span>

<span data-ttu-id="6f6b9-446">Veri ek açıklamaları model sınıfınızın ekleyerek uygulamaya doğrulama ekleyebilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-446">You can add validation to the application by adding Data Annotations to your model class.</span></span> <span data-ttu-id="6f6b9-447">Veri ek açıklamaları model özelliklerinizi uygulanan istediğiniz kuralları açıklayan izin ve ASP.NET MVC zorlama ve kullanıcılara uygun iletisini gösteren ilgileniriz.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-447">Data Annotations allow describing the rules you want applied to your model properties, and ASP.NET MVC will take care of enforcing and displaying appropriate message to users.</span></span>

<a id="Ex06Task1"></a>

<a id="Task_1_-_Adding_Data_Annotations"></a>
#### <a name="task-1---adding-data-annotations"></a><span data-ttu-id="6f6b9-448">Görev 1 - veri ek açıklamaları ekleme</span><span class="sxs-lookup"><span data-stu-id="6f6b9-448">Task 1 - Adding Data Annotations</span></span>

<span data-ttu-id="6f6b9-449">Bu görevde, uygun olduğunda doğrulama iletileri oluşturma ve düzenleme sayfası oluşturacak albüm modeline veri ek açıklamaları görüntülemek ekleyeceksiniz.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-449">In this task, you will add Data Annotations to the Album Model that will make the Create and Edit page display validation messages when appropriate.</span></span>

<span data-ttu-id="6f6b9-450">Basit bir Model sınıfı için veri ek açıklama ekleme yalnızca ekleyerek gerçekleştirilir bir **kullanarak** bildirimi **System.ComponentModel.DataAnnotation**, sonra yerleştirerek bir **[gerekli]** uygun özellikleri özniteliği.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-450">For a simple Model class, adding a Data Annotation is just handled by adding a **using** statement for **System.ComponentModel.DataAnnotation**, then placing a **[Required]** attribute on the appropriate properties.</span></span> <span data-ttu-id="6f6b9-451">Aşağıdaki örnekte yapacağınız **adı** görünümünde gerekli bir alan özelliği.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-451">The following example would make the **Name** property a required field in the View.</span></span>

[!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample18.cs)]

<span data-ttu-id="6f6b9-452">Varlık veri modeli oluşturulduğu biraz daha karmaşık durumlarda bu uygulama gibi budur.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-452">This is a little more complex in cases like this application where the Entity Data Model is generated.</span></span> <span data-ttu-id="6f6b9-453">Veri ek açıklamaları model sınıflarına doğrudan eklediyseniz, veritabanı modelden güncelleştirirseniz bunlar üzerine yazılır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-453">If you added Data Annotations directly to the model classes, they would be overwritten if you update the model from the database.</span></span> <span data-ttu-id="6f6b9-454">Bunun yerine, yapabileceğiniz hangi ek açıklamalar tutacak yer alır ve modelle ilişkili meta verileri kısmi sınıflarının sınıflarını kullanarak **[MetadataType]** özniteliği.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-454">Instead, you can make use of metadata partial classes which will exist to hold the annotations and are associated with the model classes using the **[MetadataType]** attribute.</span></span>

1. <span data-ttu-id="6f6b9-455">Açık **başlamak** çözüm bulunan **kaynak/Ex6-AddingValidation/başlangıç/** klasör.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-455">Open the **Begin** solution located at **Source/Ex6-AddingValidation/Begin/** folder.</span></span> <span data-ttu-id="6f6b9-456">Aksi takdirde kullanarak devam edebilir **son** çözüm elde edilen önceki egzersizini tamamlayarak.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-456">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="6f6b9-457">Sağlanan açtıysanız **başlamak** çözümü ihtiyaç duyacağınız bazı eksik NuGet paketlerini yüklemek devam etmeden önce.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-457">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="6f6b9-458">Bunu yapmak için tıklatın **proje** menü ve select **NuGet paketlerini Yönet**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-458">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="6f6b9-459">İçinde **NuGet paketlerini Yönet** iletişim kutusunda, tıklayın **geri** eksik paketleri indirmek için.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-459">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="6f6b9-460">Son olarak, tıklayarak çözüm oluşturun **derleme** | **Çözümü Derle**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-460">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="6f6b9-461">NuGet kullanmanın yararlarından biri, projenizdeki tüm kitaplıkları göndermeye proje boyutunu küçültmeyi gerekmemesidir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-461">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="6f6b9-462">NuGet güç araçları ile paket sürümlerini Packages.config dosyasında belirterek, gerekli tüm kitaplıkların projeyi Çalıştır ilk kez yüklemeye mümkün olmayacak.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-462">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="6f6b9-463">Bu laboratuvarda varolan bir çözümü açtıktan sonra aşağıdaki adımları çalıştırmanız gerekecek nedeni budur.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-463">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="6f6b9-464">Açık **Album.cs** gelen **modelleri** klasör.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-464">Open the **Album.cs** from the **Models** folder.</span></span>
3. <span data-ttu-id="6f6b9-465">Değiştirin **Album.cs** içerik ile vurgulanmış kodu, böylece aşağıdaki gibi görünür:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-465">Replace **Album.cs** content with the highlighted code, so that it looks like the following:</span></span>

    > [!NOTE]
    > <span data-ttu-id="6f6b9-466">Satır **[DisplayFormat(ConvertEmptyStringToNull=false)]** veri alanı veri kaynağında güncelleştirildiğinde modelinden boş dizeler null değerine dönüştürülüp olmaz olduğunu gösterir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-466">The line **[DisplayFormat(ConvertEmptyStringToNull=false)]** indicates that empty strings from the model won't be converted to null when the data field is updated in the data source.</span></span> <span data-ttu-id="6f6b9-467">Veri ek açıklama alanları doğrular önce Entity Framework modele null değerleri atarken bu ayar bir özel durum uğraşmasına gerek kalmaz.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-467">This setting will avoid an exception when the Entity Framework assigns null values to the model before Data Annotation validates the fields.</span></span>

    <span data-ttu-id="6f6b9-468">(Kod parçacığını - *ASP.NET MVC 4 Yardımcılar ve formlar ve doğrulama - Ex6 albüm meta verileri kısmi sınıf*)</span><span class="sxs-lookup"><span data-stu-id="6f6b9-468">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex6 Album metadata partial class*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample19.cs)]

    > [!NOTE]
    > <span data-ttu-id="6f6b9-469">Bu **albüm** kısmi sınıf sahip bir **MetadataType** işaret özniteliği **AlbumMetaData** için veri ek açıklama sınıfı.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-469">This **Album** partial class has a **MetadataType** attribute which points to the **AlbumMetaData** class for the Data Annotations.</span></span> <span data-ttu-id="6f6b9-470">Albüm model öğesine açıklama eklemek için kullanmakta olduğunuz veri ek açıklama öznitelikleri bazıları şunlardır:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-470">These are some of the Data Annotation attributes you are using to annotate the Album model:</span></span>
    > 
    > - <span data-ttu-id="6f6b9-471">Gereklidir - gerekli bir alan özelliği belirtir</span><span class="sxs-lookup"><span data-stu-id="6f6b9-471">Required - Indicates that the property is a required field</span></span>
    > - <span data-ttu-id="6f6b9-472">DisplayName - form alanlarını ve doğrulama iletilerinin kullanılacak metni tanımlar</span><span class="sxs-lookup"><span data-stu-id="6f6b9-472">DisplayName - Defines the text to be used on form fields and validation messages</span></span>
    > - <span data-ttu-id="6f6b9-473">-DisplayFormat veri alanlarını nasıl görüntülenir ve biçimlendirilmiş belirtir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-473">DisplayFormat - Specifies how data fields are displayed and formatted.</span></span>
    > - <span data-ttu-id="6f6b9-474">StringLength - tanımlayan bir dize alanı için en fazla uzunluk</span><span class="sxs-lookup"><span data-stu-id="6f6b9-474">StringLength - Defines a maximum length for a string field</span></span>
    > - <span data-ttu-id="6f6b9-475">Range - sayısal bir alan için bir maksimum ve minimum değer verir</span><span class="sxs-lookup"><span data-stu-id="6f6b9-475">Range - Gives a maximum and minimum value for a numeric field</span></span>
    > - <span data-ttu-id="6f6b9-476">ScaffoldColumn - sağlayan alanları Düzenleyicisi formlarda gizleme</span><span class="sxs-lookup"><span data-stu-id="6f6b9-476">ScaffoldColumn - Allows hiding fields from editor forms</span></span>

<a id="Ex06Task2"></a>

<a id="Task_2_-_Running_the_Application"></a>
#### <a name="task-2---running-the-application"></a><span data-ttu-id="6f6b9-477">Görev 2 - uygulamayı çalıştırma</span><span class="sxs-lookup"><span data-stu-id="6f6b9-477">Task 2 - Running the Application</span></span>

<span data-ttu-id="6f6b9-478">Bu görevde, oluşturma ve düzenleme sayfaları alanları doğrulamak son görevde seçilen görünen adlarını kullanarak test eder.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-478">In this task, you will test that the Create and Edit pages validate fields, using the display names chosen in the last task.</span></span>

1. <span data-ttu-id="6f6b9-479">Tuşuna **F5** uygulamayı çalıştırın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-479">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="6f6b9-480">Proje giriş sayfası başlatır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-480">The project starts in the Home page.</span></span> <span data-ttu-id="6f6b9-481">URL'yi **/StoreManager/oluşturma**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-481">Change the URL to **/StoreManager/Create**.</span></span> <span data-ttu-id="6f6b9-482">Görünen adlarını kısmi sınıf dışındaki eşleştiğinden emin olun (gibi **albüm resim URL'si** yerine **AlbumArtUrl**)</span><span class="sxs-lookup"><span data-stu-id="6f6b9-482">Verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**)</span></span>
3. <span data-ttu-id="6f6b9-483">Tıklayın **Oluştur**, form doldurma olmadan.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-483">Click **Create**, without filling the form.</span></span> <span data-ttu-id="6f6b9-484">Karşılık gelen doğrulama iletilerini aldığını doğrulayın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-484">Verify that you get the corresponding validation messages.</span></span>

    <span data-ttu-id="6f6b9-485">![Oluştur sayfasında alanlarını doğrulandı](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "Oluştur sayfasında alanlarını doğrulandı")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-485">![Validated fields in the Create page](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "Validated fields in the Create page")</span></span>

    <span data-ttu-id="6f6b9-486">*Doğrulanmış alanları oluşturma sayfası*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-486">*Validated fields in the Create page*</span></span>
4. <span data-ttu-id="6f6b9-487">Aynı ile gerçekleşir doğrulayabilirsiniz **Düzenle** sayfası.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-487">You can verify that the same occurs with the **Edit** page.</span></span> <span data-ttu-id="6f6b9-488">URL'yi **/StoreManager/Edit/1** ve görünen adlarını kısmi sınıf dışındaki eşleştiğinden emin olun (gibi **albüm resim URL'si** yerine **AlbumArtUrl**).</span><span class="sxs-lookup"><span data-stu-id="6f6b9-488">Change the URL to **/StoreManager/Edit/1** and verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**).</span></span> <span data-ttu-id="6f6b9-489">Boş **başlık** ve **fiyat** alanları ve tıklatın **Kaydet**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-489">Empty the **Title** and **Price** fields and click **Save**.</span></span> <span data-ttu-id="6f6b9-490">Karşılık gelen doğrulama iletilerini aldığını doğrulayın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-490">Verify that you get the corresponding validation messages.</span></span>

    ![Doğrulanmış alanları düzenleme sayfası](aspnet-mvc-4-helpers-forms-and-validation/_static/image19.png)

    <span data-ttu-id="6f6b9-492">*Doğrulanmış alanları düzenleme sayfası*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-492">*Validated fields in the Edit page*</span></span>

<a id="Exercise7"></a>

<a id="Exercise_7_Using_Unobtrusive_jQuery_at_Client_Side"></a>
### <a name="exercise-7-using-unobtrusive-jquery-at-client-side"></a><span data-ttu-id="6f6b9-493">Alıştırma 7: İstemci tarafında örtük jQuery kullanma</span><span class="sxs-lookup"><span data-stu-id="6f6b9-493">Exercise 7: Using Unobtrusive jQuery at Client Side</span></span>

<span data-ttu-id="6f6b9-494">Bu alıştırmada, istemci tarafındaki MVC 4 örtük jQuery doğrulamasını etkinleştirmek öğreneceksiniz.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-494">In this exercise, you will learn how to enable MVC 4 Unobtrusive jQuery validation at client side.</span></span>

> [!NOTE]
> <span data-ttu-id="6f6b9-495">Örtük jQuery JavaScript veri ajax önek intrusively yayan satır içi istemci betiklerini yerine sunucu eylem yöntemlerini çağırmak için kullanır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-495">The Unobtrusive jQuery uses data-ajax prefix JavaScript to invoke action methods on the server rather than intrusively emitting inline client scripts.</span></span>


<a id="Ex7Task1"></a>

<a id="Task_1_-_Running_the_Application_before_Enabling_Unobtrusive_jQuery"></a>
#### <a name="task-1---running-the-application-before-enabling-unobtrusive-jquery"></a><span data-ttu-id="6f6b9-496">Görev 1 - etkinleştirme örtük jQuery önce uygulamayı çalıştırma</span><span class="sxs-lookup"><span data-stu-id="6f6b9-496">Task 1 - Running the Application before Enabling Unobtrusive jQuery</span></span>

<span data-ttu-id="6f6b9-497">Bu görevde, iki doğrulama modeli karşılaştırmak için jQuery dahil olmak üzere önce uygulamayı çalışır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-497">In this task, you will run the application before including jQuery in order to compare both validation models.</span></span>

1. <span data-ttu-id="6f6b9-498">Açık **başlamak** çözüm bulunan **kaynak/Ex7-UnobtrusivejQueryValidation/başlangıç/** klasör.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-498">Open the **Begin** solution located at **Source/Ex7-UnobtrusivejQueryValidation/Begin/** folder.</span></span> <span data-ttu-id="6f6b9-499">Aksi takdirde kullanarak devam edebilir **son** çözüm elde edilen önceki egzersizini tamamlayarak.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-499">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="6f6b9-500">Sağlanan açtıysanız **başlamak** çözümü ihtiyaç duyacağınız bazı eksik NuGet paketlerini yüklemek devam etmeden önce.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-500">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="6f6b9-501">Bunu yapmak için tıklatın **proje** menü ve select **NuGet paketlerini Yönet**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-501">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="6f6b9-502">İçinde **NuGet paketlerini Yönet** iletişim kutusunda, tıklayın **geri** eksik paketleri indirmek için.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-502">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="6f6b9-503">Son olarak, tıklayarak çözüm oluşturun **derleme** | **Çözümü Derle**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-503">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="6f6b9-504">NuGet kullanmanın yararlarından biri, projenizdeki tüm kitaplıkları göndermeye proje boyutunu küçültmeyi gerekmemesidir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-504">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="6f6b9-505">NuGet güç araçları ile paket sürümlerini Packages.config dosyasında belirterek, gerekli tüm kitaplıkların projeyi Çalıştır ilk kez yüklemeye mümkün olmayacak.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-505">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="6f6b9-506">Bu laboratuvarda varolan bir çözümü açtıktan sonra aşağıdaki adımları çalıştırmanız gerekecek nedeni budur.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-506">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="6f6b9-507">Tuşuna **F5** uygulamayı çalıştırın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-507">Press **F5** to run the application.</span></span>
3. <span data-ttu-id="6f6b9-508">Proje giriş sayfası başlatır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-508">The project starts in the Home page.</span></span> <span data-ttu-id="6f6b9-509">Gözat **/StoreManager/Create** tıklatıp **Oluştur** doğrulama iletilerinin aldığını doğrulamak için form doldurma olmadan:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-509">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="6f6b9-510">![İstemci doğrulamasını devre dışı](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "istemci doğrulama devre dışı")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-510">![Client validation disabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "Client validation disabled")</span></span>

    <span data-ttu-id="6f6b9-511">*İstemci doğrulamasını devre dışı*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-511">*Client validation disabled*</span></span>
4. <span data-ttu-id="6f6b9-512">HTML kaynak kodu tarayıcıda açın:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-512">In the browser, open the HTML source code:</span></span>
...
#### <a name="task-2---enabling-unobtrusive-client-validation"></a><span data-ttu-id="6f6b9-513">Görev 2 - örtük istemci etkinleştirme doğrulama</span><span class="sxs-lookup"><span data-stu-id="6f6b9-513">Task 2 - Enabling Unobtrusive Client Validation</span></span>

<span data-ttu-id="6f6b9-514">Bu görevde, jQuery olanak sağlayacak **örtük istemci doğrulama** gelen **Web.config** dosya, varsayılan olarak tüm yeni ASP.NET MVC 4 projeleri false değerini alır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-514">In this task, you will enable jQuery **unobtrusive client validation** from **Web.config** file, which is by default set to false in all new ASP.NET MVC 4 projects.</span></span> <span data-ttu-id="6f6b9-515">Ayrıca, gerekli komut dosyası başvuruları jQuery örtük istemci doğrulama iş yapma ekleyeceksiniz.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-515">Additionally, you will add the necessary scripts references to make jQuery Unobtrusive Client Validation work.</span></span>

1. <span data-ttu-id="6f6b9-516">Açık **Web.Config** dosya proje kök dizininde ve emin **ClientValidationEnabled** ve **UnobtrusiveJavaScriptEnabled** anahtarları değerleri içinayarlanmış**true**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-516">Open **Web.Config** file at project root, and make sure that the **ClientValidationEnabled** and **UnobtrusiveJavaScriptEnabled** keys values are set to **true**.</span></span>

    [!code-xml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample21.xml)]

    > [!NOTE]
    > <span data-ttu-id="6f6b9-517">İstemci doğrulama kodu aynı sonuçları elde etmek için Global.asax.cs tarafından da etkinleştirebilirsiniz:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-517">You can also enable client validation by code at Global.asax.cs to get the same results:</span></span>
    > 
    > <span data-ttu-id="6f6b9-518">**HtmlHelper.ClientValidationEnabled = true;**</span><span class="sxs-lookup"><span data-stu-id="6f6b9-518">**HtmlHelper.ClientValidationEnabled = true;**</span></span>
    > 
    > <span data-ttu-id="6f6b9-519">Ayrıca, özel bir davranış sağlamak için tüm Denetleyicisi'nde ClientValidationEnabled özniteliği atayabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-519">Additionally, you can assign ClientValidationEnabled attribute into any controller to have a custom behavior.</span></span>
2. <span data-ttu-id="6f6b9-520">Açık **Create.cshtml** adresindeki **Views\StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-520">Open **Create.cshtml** at **Views\StoreManager**.</span></span>
3. <span data-ttu-id="6f6b9-521">Aşağıdaki komut dosyalarını emin **jquery.validate** ve **jquery.validate.unobtrusive**, görünüm üzerinden başvurulur &quot; **~/bundles/jqueryval** &quot; paket.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-521">Make sure the following script files, **jquery.validate** and **jquery.validate.unobtrusive**, are referenced in the view through the &quot;**~/bundles/jqueryval**&quot; bundle.</span></span>

    [!code-cshtml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample22.cshtml)]

    > [!NOTE]
    > <span data-ttu-id="6f6b9-522">Bu jQuery kitaplıklar yeni MVC 4 projeleri dahil edilir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-522">All these jQuery libraries are included in MVC 4 new projects.</span></span> <span data-ttu-id="6f6b9-523">Daha fazla kitaplıklarında bulabilirsiniz **/komut dosyası** , proje klasörü.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-523">You can find more libraries in the **/Scripts** folder of you project.</span></span>
    > 
    > <span data-ttu-id="6f6b9-524">Bu doğrulama yapmak için kitaplıklar çalışma, jQuery framework kitaplığına bir başvuru eklemeniz gerekir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-524">In order to make this validation libraries work, you need to add a reference to the jQuery framework library.</span></span> <span data-ttu-id="6f6b9-525">Bu başvuru zaten eklendiğinden beri  **\_Layout.cshtml** dosyası gerektirmeyen belirli bu görünümde eklemek.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-525">Since this reference is already added in the **\_Layout.cshtml** file, you do not need to add it in this particular view.</span></span>

<a id="Ex7Task3"></a>

<a id="Task_3_-_Running_the_Application_Using_Unobtrusive_jQuery_Validation"></a>
#### <a name="task-3---running-the-application-using-unobtrusive-jquery-validation"></a><span data-ttu-id="6f6b9-526">Görev 3 - uygulamayı kullanarak örtük jQuery doğrulaması çalışan</span><span class="sxs-lookup"><span data-stu-id="6f6b9-526">Task 3 - Running the Application Using Unobtrusive jQuery Validation</span></span>

<span data-ttu-id="6f6b9-527">Bu görevde, sınayacak **StoreManager** şablon kullanıcı yeni albümü oluşturduğunda, jQuery kitaplıklarını kullanarak istemci tarafı doğrulama gerçekleştirir görünüm oluşturma.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-527">In this task, you will test that the **StoreManager** create view template performs client side validation using jQuery libraries when the user creates a new album.</span></span>

1. <span data-ttu-id="6f6b9-528">Tuşuna **F5** uygulamayı çalıştırın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-528">Press **F5** to run the application.</span></span>
2. <span data-ttu-id="6f6b9-529">Proje giriş sayfası başlatır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-529">The project starts in the Home page.</span></span> <span data-ttu-id="6f6b9-530">Gözat **/StoreManager/Create** tıklatıp **Oluştur** doğrulama iletilerinin aldığını doğrulamak için form doldurma olmadan:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-530">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="6f6b9-531">![İstemci doğrulama etkin jQuery ile](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "etkin jQuery ile istemci doğrulaması")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-531">![Client validation with jQuery enabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "Client validation with jQuery enabled")</span></span>

    <span data-ttu-id="6f6b9-532">*Etkin jQuery ile istemci doğrulaması*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-532">*Client validation with jQuery enabled*</span></span>
3. <span data-ttu-id="6f6b9-533">Oluştur görünümünün için kaynak kodu tarayıcıda açın:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-533">In the browser, open the source code for Create view:</span></span>

    [!code-html[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample23.html)]

   > [!NOTE]
   > <span data-ttu-id="6f6b9-534">Her istemci doğrulama kuralı için örtük jQuery verilerle bir öznitelik ekler-val -*rulename*=&quot;*ileti*&quot;.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-534">For each client validation rule, Unobtrusive jQuery adds an attribute with data-val-*rulename*=&quot;*message*&quot;.</span></span> <span data-ttu-id="6f6b9-535">Etiketlerin listesini bu Unobtrusive aşağıdadır jQuery istemci doğrulama gerçekleştirmek için html giriş alanına ekler:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-535">Below is a list of tags that Unobtrusive jQuery inserts into the html input field to perform client validation:</span></span>
   > 
   > - <span data-ttu-id="6f6b9-536">Veri val</span><span class="sxs-lookup"><span data-stu-id="6f6b9-536">Data-val</span></span>
   > - <span data-ttu-id="6f6b9-537">Veri val numarası</span><span class="sxs-lookup"><span data-stu-id="6f6b9-537">Data-val-number</span></span>
   > - <span data-ttu-id="6f6b9-538">Veri val aralığı</span><span class="sxs-lookup"><span data-stu-id="6f6b9-538">Data-val-range</span></span>
   > - <span data-ttu-id="6f6b9-539">Veri val aralığı dakika / val aralığı maksimum veri</span><span class="sxs-lookup"><span data-stu-id="6f6b9-539">Data-val-range-min / Data-val-range-max</span></span>
   > - <span data-ttu-id="6f6b9-540">Veri val gerekiyor</span><span class="sxs-lookup"><span data-stu-id="6f6b9-540">Data-val-required</span></span>
   > - <span data-ttu-id="6f6b9-541">Veri val uzunluğu</span><span class="sxs-lookup"><span data-stu-id="6f6b9-541">Data-val-length</span></span>
   > - <span data-ttu-id="6f6b9-542">Veri-val-uzunluk-max / veri val uzunluğu dakika</span><span class="sxs-lookup"><span data-stu-id="6f6b9-542">Data-val-length-max / Data-val-length-min</span></span>
   > 
   > <span data-ttu-id="6f6b9-543">Tüm veri değerleri ile model doldurulur **veri ek açıklama**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-543">All the data values are filled with model **Data Annotation**.</span></span> <span data-ttu-id="6f6b9-544">Ardından, sunucu tarafında çalışan tüm mantığı, istemci tarafında çalıştırılabilir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-544">Then, all the logic that works at server side can be run at client side.</span></span> <span data-ttu-id="6f6b9-545">Örneğin, fiyat özniteliği aşağıdaki veri ek açıklama modele sahiptir:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-545">For example, Price attribute has the following data annotation in the model:</span></span>
   > 
   > [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample24.cs)]
   > 
   > <span data-ttu-id="6f6b9-546">Örtük jQuery kullandıktan sonra oluşturulan kod şöyledir:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-546">After using Unobtrusive jQuery, the generated code is:</span></span>
   > 
...
<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="6f6b9-547">Özet</span><span class="sxs-lookup"><span data-stu-id="6f6b9-547">Summary</span></span>

<span data-ttu-id="6f6b9-548">Bu uygulamalı laboratuvarı tamamlayarak aşağıdaki kullanarak veritabanında depolanan verileri değiştirme olanağı tanıma öğrendiniz:</span><span class="sxs-lookup"><span data-stu-id="6f6b9-548">By completing this Hands-On Lab you have learned how to enable users to change the data stored in the database with the use of the following:</span></span>

- <span data-ttu-id="6f6b9-549">Dizin oluşturma, düzenleme, silme gibi denetleyici eylemleri</span><span class="sxs-lookup"><span data-stu-id="6f6b9-549">Controller actions like Index, Create, Edit, Delete</span></span>
- <span data-ttu-id="6f6b9-550">ASP.NET MVC'nin iskele kurma özelliği ile HTML tablosu halinde özelliklerini görüntülemek için</span><span class="sxs-lookup"><span data-stu-id="6f6b9-550">ASP.NET MVC's scaffolding feature for displaying properties in an HTML table</span></span>
- <span data-ttu-id="6f6b9-551">Kullanıcı geliştirmek için özel HTML Yardımcıları deneyimi</span><span class="sxs-lookup"><span data-stu-id="6f6b9-551">Custom HTML helpers to improve user experience</span></span>
- <span data-ttu-id="6f6b9-552">HTTP GET veya POST HTTP çağrıları için react eylem yöntemleri</span><span class="sxs-lookup"><span data-stu-id="6f6b9-552">Action methods that react to either HTTP-GET or HTTP-POST calls</span></span>
- <span data-ttu-id="6f6b9-553">Benzer bir görünüm şablonları oluşturma ve düzenleme gibi paylaşılan Düzenleyici şablonu</span><span class="sxs-lookup"><span data-stu-id="6f6b9-553">A shared editor template for similar View templates like Create and Edit</span></span>
- <span data-ttu-id="6f6b9-554">Açılan listeler gibi form öğeleri</span><span class="sxs-lookup"><span data-stu-id="6f6b9-554">Form elements like drop-downs</span></span>
- <span data-ttu-id="6f6b9-555">Model doğrulama için veri ek açıklamaları</span><span class="sxs-lookup"><span data-stu-id="6f6b9-555">Data annotations for Model validation</span></span>
- <span data-ttu-id="6f6b9-556">JQuery örtük kitaplığını kullanarak istemci tarafı doğrulama</span><span class="sxs-lookup"><span data-stu-id="6f6b9-556">Client Side Validation using jQuery Unobtrusive library</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="6f6b9-557">Ek A: Web için Express 2012 Visual Studio'yu yükleme</span><span class="sxs-lookup"><span data-stu-id="6f6b9-557">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="6f6b9-558">Yükleyebileceğiniz **Web için Visual Studio Express 2012 Microsoft** veya başka bir &quot;Express&quot; sürümüyle **[Microsoft Web Platformu yükleyicisi](https://www.microsoft.com/web/downloads/platform.aspx)**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-558">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="6f6b9-559">Aşağıdaki yönergeler, yüklemek için gereken adımlarda size kılavuzluk *Web için Visual studio Express 2012* kullanarak *Microsoft Web Platformu yükleyicisi*.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-559">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="6f6b9-560">Git [ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="6f6b9-560">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="6f6b9-561">Web Platformu Yükleyicisi'ı zaten yüklediyseniz, bunun yerine ve ürün için arama açabileceğiniz &quot; <em>Visual Studio Express 2012 için Windows Azure SDK ile Web</em>&quot;.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-561">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Windows Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="6f6b9-562">Tıklayarak **Şimdi Yükle**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-562">Click on **Install Now**.</span></span> <span data-ttu-id="6f6b9-563">Yoksa **Web Platformu yükleyicisi** indirmek ve ilk yüklemek için yönlendirilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-563">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="6f6b9-564">Bir kez **Web Platformu yükleyicisi** açık tıklayın **yükleme** Kurulum'u başlatmak için.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-564">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="6f6b9-565">![Visual Studio Express yükleyin](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "Visual Studio Express'i yükle")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-565">![Install Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="6f6b9-566">*Visual Studio Express yükleyin*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-566">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="6f6b9-567">Tüm ürünlerin lisans ve koşulları okuyun ve tıklayın **kabul ediyorum** devam etmek için.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-567">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![Lisans koşullarını kabul etme](aspnet-mvc-4-helpers-forms-and-validation/_static/image23.png)

    <span data-ttu-id="6f6b9-569">*Lisans koşullarını kabul etme*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-569">*Accepting the license terms*</span></span>
5. <span data-ttu-id="6f6b9-570">İndirme ve yükleme işlemi tamamlanana kadar bekleyin.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-570">Wait until the downloading and installation process completes.</span></span>

    ![Yükleme ilerleme durumu](aspnet-mvc-4-helpers-forms-and-validation/_static/image24.png)

    <span data-ttu-id="6f6b9-572">*Yükleme ilerleme durumu*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-572">*Installation progress*</span></span>
6. <span data-ttu-id="6f6b9-573">Yükleme tamamlandığında, tıklayın **son**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-573">When the installation completes, click **Finish**.</span></span>

    ![Yükleme tamamlandı](aspnet-mvc-4-helpers-forms-and-validation/_static/image25.png)

    <span data-ttu-id="6f6b9-575">*Yükleme tamamlandı*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-575">*Installation completed*</span></span>
7. <span data-ttu-id="6f6b9-576">Tıklayın **çıkış** Web Platformu Yükleyicisi'ni kapatın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-576">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="6f6b9-577">Web için Visual Studio Express'te açmak için Git **Başlat** ekranında ve yazmaya başlayabilirsiniz &quot; **VS Express**&quot;, ardından **Web için VS Express** bir kutucuk.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-577">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![Web kutucuğu için VS Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image26.png)

    <span data-ttu-id="6f6b9-579">*Web kutucuğu için VS Express*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-579">*VS Express for Web tile*</span></span>

<a id="AppendixB"></a>

<a id="Appendix_B_Using_Code_Snippets"></a>
## <a name="appendix-b-using-code-snippets"></a><span data-ttu-id="6f6b9-580">Ek B: Kod parçacıkları</span><span class="sxs-lookup"><span data-stu-id="6f6b9-580">Appendix B: Using Code Snippets</span></span>

<span data-ttu-id="6f6b9-581">Kod parçacıkları ile parmaklarınızın ucunda ihtiyacınız olan tüm kod vardır.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-581">With code snippets, you have all the code you need at your fingertips.</span></span> <span data-ttu-id="6f6b9-582">Laboratuvar belgenin tam olarak ne zaman, kullanabilmek için aşağıdaki şekilde gösterildiği gibi size bildirir.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-582">The lab document will tell you exactly when you can use them, as shown in the following figure.</span></span>

<span data-ttu-id="6f6b9-583">![Kod projenize eklemek için Visual Studio kod parçacıkları](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "kod projenize eklemek için Visual Studio kullanarak kod parçacıkları")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-583">![Using Visual Studio code snippets to insert code into your project](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "Using Visual Studio code snippets to insert code into your project")</span></span>

<span data-ttu-id="6f6b9-584">*Kod projenize eklemek için Visual Studio kod parçacıkları*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-584">*Using Visual Studio code snippets to insert code into your project*</span></span>

<span data-ttu-id="6f6b9-585">***Klavye (yalnızca C#) kullanarak bir kod parçacığı eklemek için***</span><span class="sxs-lookup"><span data-stu-id="6f6b9-585">***To add a code snippet using the keyboard (C# only)***</span></span>

1. <span data-ttu-id="6f6b9-586">Kod eklemesini istediğiniz imleci yerleştirin.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-586">Place the cursor where you would like to insert the code.</span></span>
2. <span data-ttu-id="6f6b9-587">(Olmadan, boşluk veya tire) kod parçacığı adı yazmaya başlayın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-587">Start typing the snippet name (without spaces or hyphens).</span></span>
3. <span data-ttu-id="6f6b9-588">Kod parçacıkları adlarla eşleşen IntelliSense görüntüler izleyin.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-588">Watch as IntelliSense displays matching snippets' names.</span></span>
4. <span data-ttu-id="6f6b9-589">Doğru kod parçacığını seçin (veya tüm parçacığının adı seçilene kadar yazmaya devam edin).</span><span class="sxs-lookup"><span data-stu-id="6f6b9-589">Select the correct snippet (or keep typing until the entire snippet's name is selected).</span></span>
5. <span data-ttu-id="6f6b9-590">İki kez İmleç konumuna kod parçacığını eklemek için SEKME tuşuna basın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-590">Press the Tab key twice to insert the snippet at the cursor location.</span></span>

<span data-ttu-id="6f6b9-591">![Kod parçacığı adını yazmaya başlayın](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "kod parçacığı adını yazmaya başlayın")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-591">![Start typing the snippet name](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "Start typing the snippet name")</span></span>

<span data-ttu-id="6f6b9-592">*Kod parçacığı adını yazmaya başlayın*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-592">*Start typing the snippet name*</span></span>

<span data-ttu-id="6f6b9-593">![Vurgulanan kod parçacığı seçmek için SEKME tuşuna basın](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "vurgulanan kod parçacığı seçmek için Tab tuşuna basın")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-593">![Press Tab to select the highlighted snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "Press Tab to select the highlighted snippet")</span></span>

<span data-ttu-id="6f6b9-594">*Vurgulanan kod parçacığı seçmek için SEKME tuşuna basın*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-594">*Press Tab to select the highlighted snippet*</span></span>

<span data-ttu-id="6f6b9-595">![Yeniden Tab tuşuna basın ve kod parçacığı genişletir](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "yeniden Tab tuşuna basın ve kod parçacığı genişletir")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-595">![Press Tab again and the snippet will expand](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "Press Tab again and the snippet will expand")</span></span>

<span data-ttu-id="6f6b9-596">*Yeniden Tab tuşuna basın ve kod parçacığı genişletir*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-596">*Press Tab again and the snippet will expand*</span></span>

<span data-ttu-id="6f6b9-597">***Fare (C#, Visual Basic ve XML) kullanarak bir kod parçacığı eklemek için*** 1.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-597">***To add a code snippet using the mouse (C#, Visual Basic and XML)*** 1.</span></span> <span data-ttu-id="6f6b9-598">Kod parçacığını eklemek istediğiniz yeri sağ tıklayın.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-598">Right-click where you want to insert the code snippet.</span></span>

1. <span data-ttu-id="6f6b9-599">Seçin **parçacık Ekle** ardından **kod Parçacıklarım**.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-599">Select **Insert Snippet** followed by **My Code Snippets**.</span></span>
2. <span data-ttu-id="6f6b9-600">Tıklayarak ilgili kod parçacığı listeden seçin.</span><span class="sxs-lookup"><span data-stu-id="6f6b9-600">Pick the relevant snippet from the list, by clicking on it.</span></span>

<span data-ttu-id="6f6b9-601">![İstediğiniz kod parçacığını eklemek ve parçacık eklemek için sağ tıklama](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "sağ tıklayın, istediğiniz kod parçacığını eklemek ve kod parçacığı Ekle")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-601">![Right-click where you want to insert the code snippet and select Insert Snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "Right-click where you want to insert the code snippet and select Insert Snippet")</span></span>

<span data-ttu-id="6f6b9-602">*Kod parçacığını eklemek ve parçacık eklemek istediğiniz sağ tıklayın*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-602">*Right-click where you want to insert the code snippet and select Insert Snippet*</span></span>

<span data-ttu-id="6f6b9-603">![Tıklayarak ilgili kod parçacığını listesinden çekme](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "tıklayarak ilgili kod parçacığı listeden seçin")</span><span class="sxs-lookup"><span data-stu-id="6f6b9-603">![Pick the relevant snippet from the list, by clicking on it](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "Pick the relevant snippet from the list, by clicking on it")</span></span>

<span data-ttu-id="6f6b9-604">*Tıklayarak ilgili kod parçacığı listeden seçin*</span><span class="sxs-lookup"><span data-stu-id="6f6b9-604">*Pick the relevant snippet from the list, by clicking on it*</span></span>
