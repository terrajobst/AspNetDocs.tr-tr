...
---
# <a name="iteration-4--make-the-application-loosely-coupled-c"></a>Yineleme #4: uygulamayı gevşek olarak bağlanmış hale getirmeC#()
...
**Listeleme 1-Models\icontactmanagerdepotory.cs**
...
**Listeleme 2-Models\entitycontactmanagerdepotory.cs**
