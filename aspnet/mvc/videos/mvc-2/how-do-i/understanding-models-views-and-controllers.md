...
Modelleri, görünümleri ve denetleyicileri hakkında yanıltıcı? Bu öğreticide, Stephen Walther bir ASP.NET MVC uygulaması için farklı parçalarını tanıtır. Bu videoda hakkında ek bilgi için "Anlama modelleri, görünümleri ve denetleyicileri" öğreticiyi okuyun ([C#](../../../overview/older-versions-1/overview/understanding-models-views-and-controllers-cs.md), [VB](../../../overview/older-versions-1/overview/understanding-models-views-and-controllers-vb.md)).

[&#9654;Videoyu (13 dakika)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/understanding-models-views-and-controllers)
