...
Aşağıdaki performans sayaçları yardımcı programlar paketi yükler. Son uygulama havuzunu veya sunucu yeniden başlatıldığından beri "Toplam" sayaçları, olay sayısını ölçer.
