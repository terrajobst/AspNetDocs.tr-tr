...
<span data-ttu-id="50c1e-169">**Olayları olay günlüğüne XML sunucu kodu**</span><span class="sxs-lookup"><span data-stu-id="50c1e-169">**XML server code for logging events to the event log**</span></span>
