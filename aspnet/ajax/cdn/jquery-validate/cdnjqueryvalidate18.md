...
ms.locfileid: "78585066"
---
# <a name="jqueryvalidate-version-18"></a><span data-ttu-id="032b6-102">jquery.validate sürümü 1.8</span><span class="sxs-lookup"><span data-stu-id="032b6-102">jquery.validate version 1.8</span></span>

<span data-ttu-id="032b6-103">Aşağıdaki dosyalar CDN 'de barındırılır:</span><span class="sxs-lookup"><span data-stu-id="032b6-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="032b6-104">Yerelleştirme dosyaları # #, Loc kodudur https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js.</span><span class="sxs-lookup"><span data-stu-id="032b6-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js where ## is the loc code.</span></span>
