...
ms.locfileid: "78585192"
---
# <a name="jquery-validation-1110"></a><span data-ttu-id="41460-102">jQuery Doğrulaması 1.11.0</span><span class="sxs-lookup"><span data-stu-id="41460-102">jQuery Validation 1.11.0</span></span>

<span data-ttu-id="41460-103">Aşağıdaki dosyalar CDN 'de barındırılır:</span><span class="sxs-lookup"><span data-stu-id="41460-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="41460-104">Yerelleştirme dosyaları # #, Loc kodudur https://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.0/localization/messages\_##.js.</span><span class="sxs-lookup"><span data-stu-id="41460-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.0/localization/messages\_##.js where ## is the loc code.</span></span>
