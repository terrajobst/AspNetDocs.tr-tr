...
title: ASP.NET Web Forms ve Ajax 4.5.2 | Microsoft Docs
...
ms.locfileid: "57067836"
---
<a name="aspnet-web-forms-and-ajax-452"></a><span data-ttu-id="809ea-102">ASP.NET Web Forms ve Ajax 4.5.2</span><span class="sxs-lookup"><span data-stu-id="809ea-102">ASP.NET Web Forms and Ajax 4.5.2</span></span>
====================
<span data-ttu-id="809ea-103">Aşağıdaki dosyalar, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="809ea-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="809ea-104">Not: Fr-FR.js gibi Genelleştirme komut dosyaları aşağıdaki klasörde bulunabilir:</span><span class="sxs-lookup"><span data-stu-id="809ea-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
