...
ms.locfileid: "57073596"
---
<a name="jquery-datatables-190"></a><span data-ttu-id="d3a84-102">jQuery DataTables 1.9.0</span><span class="sxs-lookup"><span data-stu-id="d3a84-102">jQuery DataTables 1.9.0</span></span>
====================
<span data-ttu-id="d3a84-103">Aşağıdaki dosyalar için jQuery DataTable eklentileri, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="d3a84-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
