...
ms.locfileid: "59387639"
---
# <a name="jquery-datatables-192"></a><span data-ttu-id="cfaa3-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="cfaa3-102">jQuery DataTables 1.9.2</span></span>

<span data-ttu-id="cfaa3-103">Aşağıdaki dosyalar için jQuery DataTable eklentileri, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="cfaa3-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
