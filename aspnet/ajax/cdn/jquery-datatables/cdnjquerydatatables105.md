...
ms.locfileid: "59415940"
---
# <a name="jquery-datatables-1105"></a><span data-ttu-id="774c9-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="774c9-102">jQuery DataTables 1.10.5</span></span>

<span data-ttu-id="774c9-103">Aşağıdaki dosyalar için jQuery DataTable eklentileri, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="774c9-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
