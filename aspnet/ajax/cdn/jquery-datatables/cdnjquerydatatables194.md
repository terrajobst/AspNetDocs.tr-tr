...
ms.locfileid: "78563212"
---
# <a name="jquery-datatables-194"></a><span data-ttu-id="ccf23-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="ccf23-102">jQuery DataTables 1.9.4</span></span>

<span data-ttu-id="ccf23-103">JQuery DataTable eklentileri için aşağıdaki dosyalar CDN 'de barındırılır:</span><span class="sxs-lookup"><span data-stu-id="ccf23-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
