...
ms.locfileid: "78563331"
---
# <a name="jquery-datatables-1104"></a><span data-ttu-id="f37e4-102">jQuery DataTables 1.10.4</span><span class="sxs-lookup"><span data-stu-id="f37e4-102">jQuery DataTables 1.10.4</span></span>

<span data-ttu-id="f37e4-103">JQuery DataTable eklentileri için aşağıdaki dosyalar CDN 'de barındırılır:</span><span class="sxs-lookup"><span data-stu-id="f37e4-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
