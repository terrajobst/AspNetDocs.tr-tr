...
ms.locfileid: "59420074"
---
# <a name="jquery-mobile-10-rc1-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="052c4-102">Microsoft Ajax CDN üzerinde jQuery Mobile 1.0 RC1</span><span class="sxs-lookup"><span data-stu-id="052c4-102">jQuery Mobile 1.0 RC1 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="052c4-103">JQuery Mobile 1.0 RC 1 kitaplığı aşağıdaki dosyaları içerir:</span><span class="sxs-lookup"><span data-stu-id="052c4-103">The jQuery Mobile 1.0 RC 1 library includes the following files:</span></span>
