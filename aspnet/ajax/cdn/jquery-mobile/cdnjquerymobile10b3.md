...
ms.locfileid: "78563114"
---
# <a name="jquery-mobile-10-beta-3-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="f3b80-102">Microsoft Ajax CDN üzerinde jQuery Mobile 1.0 Beta 3</span><span class="sxs-lookup"><span data-stu-id="f3b80-102">jQuery Mobile 1.0 Beta 3 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="f3b80-103">JQuery Mobile 1,0 Beta 3 kitaplığı, aşağıdaki dosyaları içerir:</span><span class="sxs-lookup"><span data-stu-id="f3b80-103">The jQuery Mobile 1.0 Beta 3 library includes the following files:</span></span>
