...
ms.locfileid: "78562743"
---
# <a name="jquery-mobile-145-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="db668-102">Microsoft Ajax CDN üzerinde jQuery Mobile 1.4.5</span><span class="sxs-lookup"><span data-stu-id="db668-102">jQuery Mobile 1.4.5 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="db668-103">JQuery Mobile 1.4.5 kitaplığı aşağıdaki dosyaları içerir:</span><span class="sxs-lookup"><span data-stu-id="db668-103">The jQuery Mobile 1.4.5 library includes the following files:</span></span>
