...
ms.locfileid: "78562757"
---
# <a name="jquery-templates-beta-1"></a><span data-ttu-id="b963a-102">jQuery Şablonları Beta 1</span><span class="sxs-lookup"><span data-stu-id="b963a-102">jQuery Templates Beta 1</span></span>

<span data-ttu-id="b963a-103">JQuery şablonları eklentisi aşağıdaki dosyaları içerir:</span><span class="sxs-lookup"><span data-stu-id="b963a-103">The jQuery Templates plugin includes the following files:</span></span>
