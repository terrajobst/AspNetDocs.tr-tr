...
> Bu öğreticide, bir konsol uygulaması içinde bir web API'sini barındıran gösterilmektedir. ASP.NET Web API, IIS gerektirmez. Web API'si kendi ana bilgisayar işlemi kendi kendine barındırabilirsiniz. 
> 
