...
---
# <a name="introduction-to-load-testing-web-applications-with-team-system"></a>Team System ile Web uygulamalarını test etmeye giriş

Eric eser tarafından

Bu videoda, Visual Studio Team System 'in yük testi özelliklerini kullanarak Web uygulamalarınızı nasıl yüklerinizi test edebilirsiniz.

[&#9654;Videoyu izleyin (9 dakika)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/introduction-to-load-testing-web-applications-with-team-system)
