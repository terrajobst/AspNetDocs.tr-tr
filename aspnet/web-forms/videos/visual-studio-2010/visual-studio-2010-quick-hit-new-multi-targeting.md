...
---
# <a name="visual-studio-2010-quick-hit---new-multi-targeting"></a>Visual Studio 2010 "Hızlı isabet" - yeni çoklu hedefleme

tarafından [ALi Stagner](https://github.com/JoeStagner)

Bu videoda kullanın ve birden çok .NET sürümlerini hedefleyen olanak tanıyan Visual Studio'nun Gelişmiş multi-targeting'e desteğin nasıl kullanılacağını öğreneceksiniz.

[&#9654;(6 dakika) videosunu izleyin](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/visual-studio-2010-quick-hit-new-multi-targeting)
