...
---
# <a name="aspnet-45-web-forms-model-binding"></a>ASP.NET 4.5 Web Forms Model Bağlama

tarafından [Scott Hanselman](https://github.com/shanselman)

[&#9654;(7 dakika) videosunu izleyin](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-45-web-forms-model-binding)

> [!div class="step-by-step"]
> [Önceki](aspnet-vnext-videos-model-binding-part-3-updating.md)
> [İleri](aspnet-45-web-forms-strong-typed-data-controls.md)
