...
[Örnek uygulamayı indirin](http://download.microsoft.com/download/4/6/3/463cf87c-4724-4cbc-b7b5-3f866f43ba50/ASPNET_Data_Tutorial_2_CS.exe) veya [PDF olarak indirin](creating-a-business-logic-layer-cs/_static/datatutorial02cs1.pdf)
...
[![THe ürünleri listeler GridView görüntülenen](creating-a-business-logic-layer-cs/_static/image4.png)](creating-a-business-logic-layer-cs/_static/image3.png)
...
[![THe DataColumn sağlayan temel alan düzeyindeki doğrulama](creating-a-business-logic-layer-cs/_static/image7.png)](creating-a-business-logic-layer-cs/_static/image6.png)
...
[![Add App_Code klasörü için yeni bir sınıf](creating-a-business-logic-layer-cs/_static/image10.png)](creating-a-business-logic-layer-cs/_static/image9.png)
...
DAL ve BLL tam size sunduğumuz sunu katmanına başlamak hazırsınız. İçinde [sonraki öğreticiye](master-pages-and-site-navigation-cs.md) biz kısa bir sapma veri erişim konulardan yararlanın ve öğreticileri boyunca kullanmanız için bir tutarlı sayfa düzeni tanımlamak.
