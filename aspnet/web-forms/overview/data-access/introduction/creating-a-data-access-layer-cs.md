...
ms.locfileid: "59420607"
---
# <a name="creating-a-data-access-layer-c"></a>Veri Erişim Katmanını Oluşturma (C#)

tarafından [Scott Mitchell](https://twitter.com/ScottOnWriting)

[PDF'yi indirin](creating-a-data-access-layer-cs/_static/datatutorial01cs1.pdf)
...
[![CNew File System-Based Web sitesi oluştur](creating-a-data-access-layer-cs/_static/image2.png)](creating-a-data-access-layer-cs/_static/image1.png)
...
[![AVeri erişim kodu, DAL ile gönderilen ll](creating-a-data-access-layer-cs/_static/image6.png)](creating-a-data-access-layer-cs/_static/image5.png)

**Şekil 3**: Tüm veri erişim kodu DAL ile sahip ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-cs/_static/image7.png))
...
[![CProjeniz için yeni bir veri kümesi eklemek için seçin](creating-a-data-access-layer-cs/_static/image9.png)](creating-a-data-access-layer-cs/_static/image8.png)

**Şekil 4**: Projeniz için yeni bir veri kümesi eklemek seçin ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-cs/_static/image10.png))
...
[![CNorthwind veritabanı aşağı açılan listeden seçin](creating-a-data-access-layer-cs/_static/image12.png)](creating-a-data-access-layer-cs/_static/image11.png)

**Şekil 5**: Northwind veritabanı aşağı açılan listeden seçin ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-cs/_static/image13.png))
...
[![SWeb.config dosyasında bağlantı dizesini Ave](creating-a-data-access-layer-cs/_static/image15.png)](creating-a-data-access-layer-cs/_static/image14.png)
...
[![QGeçici SQL deyimi kullanarak verileri sorgu](creating-a-data-access-layer-cs/_static/image18.png)](creating-a-data-access-layer-cs/_static/image17.png)
...
[![ESQL sorgu içine metin girin](creating-a-data-access-layer-cs/_static/image21.png)](creating-a-data-access-layer-cs/_static/image20.png)
...
[![CSorgu grafik sorgu Düzenleyicisi aracılığıyla Oluştur](creating-a-data-access-layer-cs/_static/image24.png)](creating-a-data-access-layer-cs/_static/image23.png)
...
[![SYalnızca Generate INSERT, Update ve Delete deyimleri seçeneği tercih](creating-a-data-access-layer-cs/_static/image27.png)](creating-a-data-access-layer-cs/_static/image26.png)
...
[![CYöntem adına GetData GetProducts Değiştir](creating-a-data-access-layer-cs/_static/image30.png)](creating-a-data-access-layer-cs/_static/image29.png)
...
[![Ttürü belirtilmiş veri kümesi kendisi ürünleri DataTable ve düzenleyen eklenmiş olan](creating-a-data-access-layer-cs/_static/image33.png)](creating-a-data-access-layer-cs/_static/image32.png)
...
[![THe ürünleri listeler GridView görüntülenen](creating-a-data-access-layer-cs/_static/image36.png)](creating-a-data-access-layer-cs/_static/image35.png)
...
[![Cbir seçin deyimi olan satırları döndürür oluşturulacağını seçin](creating-a-data-access-layer-cs/_static/image40.png)](creating-a-data-access-layer-cs/_static/image39.png)
...
Sonraki adım, verilere erişmek için kullanılan SQL sorgusunun tanımlamaktır. Belirli bir kategoriye ait ürünleri döndürmek istediğimiz olduğundan, aynı kullanmam <strong>seçin</strong> deyimden <strong>GetProducts()</strong>, ancak aşağıdaki <strong>burada</strong> yan tümcesi: <strong>Burada CategoryID = @CategoryID</strong> . <strong>@CategoryID</strong> Parametresi için TableAdapter Sihirbazı'nı oluşturma yöntemi giriş parametresi (yani, boş değer atanabilir bir tamsayı) ilgili türden gerektiğini gösterir.


[![EYalnızca dönüş ürünlere belirtilen bir kategorideki bir sorgu girin](creating-a-data-access-layer-cs/_static/image43.png)](creating-a-data-access-layer-cs/_static/image42.png)
...
[![CTableAdapter metotları adlarını seçin](creating-a-data-access-layer-cs/_static/image46.png)](creating-a-data-access-layer-cs/_static/image45.png)
...
[![TGösterilen hortum İçecekler kategorisindeki ürünlerin ait](creating-a-data-access-layer-cs/_static/image50.png)](creating-a-data-access-layer-cs/_static/image49.png)

**Şekil 19**: Bu ürünler ait İçecekler kategorisindeki gösterilir ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-cs/_static/image51.png))
...
[![Thortum İçecekler kategorisindeki ürünlerin görüntülenen](creating-a-data-access-layer-cs/_static/image53.png)](creating-a-data-access-layer-cs/_static/image52.png)
...
[![EACH ekleme, güncelleştirme ve silme isteği gönderildi veritabanı anında](creating-a-data-access-layer-cs/_static/image56.png)](creating-a-data-access-layer-cs/_static/image55.png)

**Şekil 21**: Her bir INSERT, Update ve Delete isteği veritabanı anında gönderilir ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-cs/_static/image57.png))
...
[![ADeğişiklikler veritabanı, güncelleştirme yöntemi ile eşitlenir ll çağrılan](creating-a-data-access-layer-cs/_static/image59.png)](creating-a-data-access-layer-cs/_static/image58.png)
...
[![TTableAdapter InsertCommand ve UpdateCommand DeleteCommand özellikleri sahip](creating-a-data-access-layer-cs/_static/image62.png)](creating-a-data-access-layer-cs/_static/image61.png)

**Şekil 23**: TableAdapter'in **InsertCommand**, **UpdateCommand**, ve **DeleteCommand** özellikleri ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-cs/_static/image63.png))
...
[![CYapılandır INSERT, UPDATE ve DELETE deyimleri Sorgu Tasarımcısı](creating-a-data-access-layer-cs/_static/image65.png)](creating-a-data-access-layer-cs/_static/image64.png)

**Şekil 24**: Yapılandırma **Ekle**, **güncelleştirme**, ve **Sil** deyimlerinde Sorgu Oluşturucusu ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-cs/_static/image66.png))
...
[![CÜrünleri tabloya yeni satır eklemek için bir yöntem Oluştur](creating-a-data-access-layer-cs/_static/image68.png)](creating-a-data-access-layer-cs/_static/image67.png)
...
[![Augment SCOPE_IDENTITY() değeri döndürmek için sorguyu](creating-a-data-access-layer-cs/_static/image71.png)](creating-a-data-access-layer-cs/_static/image70.png)

**Şekil 26**: Döndürülecek sorgu büyütmek **kapsam\_IDENTITY()** değeri ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-cs/_static/image72.png))


Son olarak, yeni yöntemin adı **InsertProduct**.


[![Set InsertProduct için yeni yöntem adı](creating-a-data-access-layer-cs/_static/image74.png)](creating-a-data-access-layer-cs/_static/image73.png)
...
[![Cskaler ExecuteMode özelliğini Değiştir](creating-a-data-access-layer-cs/_static/image77.png)](creating-a-data-access-layer-cs/_static/image76.png)
...
[![Uteni GetProducts() yöntemi için SELECT deyimi](creating-a-data-access-layer-cs/_static/image80.png)](creating-a-data-access-layer-cs/_static/image79.png)
...
[![To veri kümesi Tasarımcısı sonra dört TableAdapters eklenmiştir](creating-a-data-access-layer-cs/_static/image84.png)](creating-a-data-access-layer-cs/_static/image83.png)
...
[![THe kategoriye türü belirtilmiş veri kümesi için XML şema tanımı (XSD) dosyası](creating-a-data-access-layer-cs/_static/image87.png)](creating-a-data-access-layer-cs/_static/image86.png)
...
[![THe Tedarikçi şirket adı sol sütunda, Their ürünleri sağ listelenen](creating-a-data-access-layer-cs/_static/image92.png)](creating-a-data-access-layer-cs/_static/image91.png)
