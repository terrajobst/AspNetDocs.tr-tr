...
[Kodu indir](http://download.microsoft.com/download/3/9/f/39f92b37-e92e-4ab3-909e-b4ef23d01aa3/ASPNET_Data_Tutorial_66_VB.zip) veya [PDF olarak indirin](batch-inserting-vb/_static/datatutorial66vb1.pdf)
...
[![THe toplu ekleme arabirimi](batch-inserting-vb/_static/image2.png)](batch-inserting-vb/_static/image1.png)
...
[![DTasarımcı araç kutusundan bir Panel zin](batch-inserting-vb/_static/image5.png)](batch-inserting-vb/_static/image4.png)
...
[![Dörüntü ProductsBLL sınıfından s GetProducts yöntemi döndürülen verileri](batch-inserting-vb/_static/image8.png)](batch-inserting-vb/_static/image7.png)
...
[![SGüncelleştirme, ekleme ve silme sekmeler (hiçbiri) açılan listelerde Et](batch-inserting-vb/_static/image11.png)](batch-inserting-vb/_static/image10.png)
...
[![THe GridView ürünleri ve sıralama sunar ve disk belleği özellikleri listeler](batch-inserting-vb/_static/image14.png)](batch-inserting-vb/_static/image13.png)
...
[![TArabirim ekleme oluşur he bir dört sütunlu, satır içi yedi tablo](batch-inserting-vb/_static/image17.png)](batch-inserting-vb/_static/image16.png)
...
[![CObjectDataSource SuppliersBLL sınıfı s GetSuppliers yöntemi kullanmak için Yapılandır](batch-inserting-vb/_static/image20.png)](batch-inserting-vb/_static/image19.png)
...
[![Dörüntü ŞirketAdı veri ve kullanım SupplierID değeri](batch-inserting-vb/_static/image23.png)](batch-inserting-vb/_static/image22.png)
...
[![To üst bilgi satırı artık üreticiler ve kategorileri DropDownList içeren](batch-inserting-vb/_static/image26.png)](batch-inserting-vb/_static/image25.png)
...
[![THe ekleme arabirimi artık içeren metin kutuları fiyatları ve ürün adları için](batch-inserting-vb/_static/image29.png)](batch-inserting-vb/_static/image28.png)
...
[![PStatusLabel denetim Yukarıdaki iki Panel denetimleri Oya](batch-inserting-vb/_static/image32.png)](batch-inserting-vb/_static/image31.png)
...
[![THe ekleme arabirimi işlem ürün sevk düğmesine tıkladıktan sonra görüntülenen](batch-inserting-vb/_static/image35.png)](batch-inserting-vb/_static/image34.png)
...
[![A Ürün adı, gerekli olduğunda girerek bir birim fiyatı olan](batch-inserting-vb/_static/image38.png)](batch-inserting-vb/_static/image37.png)
...
[![Tüç yeni Veggies eklenmiştir tedarikçi Mayumi s](batch-inserting-vb/_static/image41.png)](batch-inserting-vb/_static/image40.png)
...
[![TGridView'ın son sayfasının kendisine yeni ürünler bulunabilir](batch-inserting-vb/_static/image44.png)](batch-inserting-vb/_static/image43.png)
...
Bu ve önceki iki öğreticiler güncelleştirmek için silme, izin arabirimleri oluşturduk ve toplu veri ekleme, her biri işlem desteği ekledik veri erişim katmanı için kullanılan [veritabanı değişikliklerini sarmalama bir işlem içinde](wrapping-database-modifications-within-a-transaction-vb.md) öğretici. Belirli senaryoları, gibi toplu işleme kullanıcı arabirimleri büyük ölçüde son kullanıcı verimliliği keserek ayrıca temel alınan verilerin bütünlüğünü sürdürürken tıklama, Geri göndermeler ve klavye ve fare bağlam anahtarları sayısını artırın.
