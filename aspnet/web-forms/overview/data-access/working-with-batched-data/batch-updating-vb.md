...
[![EGridView satırında ACH düzenlenebilir olduğunu](batch-updating-vb/_static/image1.gif)](batch-updating-vb/_static/image1.png)
...
[![CObjectDataSource ProductsBLL sınıfını kullanmak için Yapılandır](batch-updating-vb/_static/image2.gif)](batch-updating-vb/_static/image3.png)
...
[![Retrieve GetProducts yöntemi kullanarak ürün verileri](batch-updating-vb/_static/image3.gif)](batch-updating-vb/_static/image5.png)
...
[![SGüncelleştirme, ekleme ve silme sekmeler (hiçbiri) açılan listelerde Et](batch-updating-vb/_static/image4.gif)](batch-updating-vb/_static/image7.png)
...
[![THe ProductName TemplateField artık bir metin kutusu ve bir RequiredFieldValidator eklemeler](batch-updating-vb/_static/image6.gif)](batch-updating-vb/_static/image9.png)
...
[![Add bir CompareValidator fiyat girildiğinden emin olun, negatif olmayan bir para birimi değeri olan](batch-updating-vb/_static/image7.gif)](batch-updating-vb/_static/image11.png)
...
[![CObjectDataSource CategoriesBLL sınıfını kullanmak için Yapılandır](batch-updating-vb/_static/image8.gif)](batch-updating-vb/_static/image13.png)
...
[![Retrieve GetCategories yöntemini kullanarak kategori verileri](batch-updating-vb/_static/image9.gif)](batch-updating-vb/_static/image15.png)
...
[![Set açılan listeler güncelleştirme ve silme sekmelerde (hiçbiri)](batch-updating-vb/_static/image10.gif)](batch-updating-vb/_static/image17.png)
...
[![BUL CategoriesDataSource DropDownList'e](batch-updating-vb/_static/image11.gif)](batch-updating-vb/_static/image19.png)
...
[![EGridView satır ACH düzenlenebilir olduğunu](batch-updating-vb/_static/image13.gif)](batch-updating-vb/_static/image21.png)
...
[![THe sayfası artık içeren iki güncelleştirme ürünleri düğme](batch-updating-vb/_static/image16.gif)](batch-updating-vb/_static/image23.png)
