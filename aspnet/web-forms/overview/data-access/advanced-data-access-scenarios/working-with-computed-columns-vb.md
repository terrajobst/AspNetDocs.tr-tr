...
Şekil 2 ' de gösterildiği gibi sonuçlar, `CompanyName`, `ContactName`ve `ContactTitle` sütunları (`ContactName`,`ContactTitle`) kullanarak listeleyen `FullContactName`içerir.
