...
[![Add DropDownList için yeni bir veri kaynağı](master-detail-filtering-with-two-dropdownlists-vb/_static/image2.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image1.png)
...
[![CCategoriesBLL sınıfını kullanmak için toplanmasını](master-detail-filtering-with-two-dropdownlists-vb/_static/image5.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image4.png)
...
[![CObjectDataSource GetCategories() yöntemi kullanmak üzere Yapılandır](master-detail-filtering-with-two-dropdownlists-vb/_static/image8.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image7.png)
...
[![HAve CategoryName alanı DropDownList görüntülemek ve kullanmak CategoryID değeri](master-detail-filtering-with-two-dropdownlists-vb/_static/image11.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image10.png)
...
[![EKategorileri DropDownList için AutoPostBack etkinleştir](master-detail-filtering-with-two-dropdownlists-vb/_static/image14.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image13.png)
...
[![Add ProductsByCategory DropDownList için yeni bir veri kaynağı](master-detail-filtering-with-two-dropdownlists-vb/_static/image17.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image16.png)
...
[![CAdlı yeni bir ObjectDataSource ProductsByCategoryDataSource Oluştur](master-detail-filtering-with-two-dropdownlists-vb/_static/image20.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image19.png)
...
[![CProductsBLL sınıfını kullanmak için toplanmasını](master-detail-filtering-with-two-dropdownlists-vb/_static/image23.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image22.png)
...
[![CObjectDataSource GetProductsByCategoryID(categoryID) yöntemi kullanmak üzere Yapılandır](master-detail-filtering-with-two-dropdownlists-vb/_static/image26.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image25.png)
...
[![Ptam parametre değerinin kategorileri DropDownList CategoryID](master-detail-filtering-with-two-dropdownlists-vb/_static/image29.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image28.png)
...
[![SVeri kaynağı alanları kullanılan DropDownList için 's adejte adresu ListItems metin ve değer Özellikleri](master-detail-filtering-with-two-dropdownlists-vb/_static/image32.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image31.png)
...
[![WSeçili olduğunda ilk ziyaret edin sayfasında, İçecekler kategorisindeki](master-detail-filtering-with-two-dropdownlists-vb/_static/image35.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image34.png)
...
[![CFarklı bir kategori hoosing yeni kategori ürünleri görüntüler](master-detail-filtering-with-two-dropdownlists-vb/_static/image38.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image37.png)
...
[![EDropDownList productsByCategory AutoPostBack özelliğini etkinleştir](master-detail-filtering-with-two-dropdownlists-vb/_static/image41.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image40.png)
...
[![CProductsBLL sınıfını kullanmak için toplanmasını](master-detail-filtering-with-two-dropdownlists-vb/_static/image44.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image43.png)
...
[![CObjectDataSource GetProductByProductID(productID) yöntemi kullanmak üzere Yapılandır](master-detail-filtering-with-two-dropdownlists-vb/_static/image47.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image46.png)
...
[![Ptam parametre değerinin ProductsByCategory DropDownList ProductID](master-detail-filtering-with-two-dropdownlists-vb/_static/image50.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image49.png)
...
[![Tiçinde bir DetailsView he seçili ürün uygulamasının ayrıntılar görüntülenir](master-detail-filtering-with-two-dropdownlists-vb/_static/image53.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image52.png)
...
[![THe daha önce seçilen ürün uygulamasının Ayrıntılar görüntülenmeye olan](master-detail-filtering-with-two-dropdownlists-vb/_static/image56.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image55.png)
...
[![THe ProductsByCategory DropDownList değeri değişiklikleri sonra tazelemek DetailsView's ObjectDataSource denetler değişiklikler](master-detail-filtering-with-two-dropdownlists-vb/_static/image59.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image58.png)
...
[![THe tazelemek DetailsView açıkça yenilenir olduğunda ProductsByCategory DropDownList's DataBound olay harekete geçirilir 's](master-detail-filtering-with-two-dropdownlists-vb/_static/image62.png)](master-detail-filtering-with-two-dropdownlists-vb/_static/image61.png)
