...
[![Sbir DropDownList ait veri kaynağı belirt](master-detail-filtering-with-a-dropdownlist-vb/_static/image2.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image1.png)
...
[![Add adlı yeni bir ObjectDataSource CategoriesDataSource](master-detail-filtering-with-a-dropdownlist-vb/_static/image5.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image4.png)
...
[![CCategoriesBLL sınıfını kullanmak için toplanmasını](master-detail-filtering-with-a-dropdownlist-vb/_static/image8.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image7.png)
...
[![CObjectDataSource GetCategories() yöntemi kullanmak üzere Yapılandır](master-detail-filtering-with-a-dropdownlist-vb/_static/image11.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image10.png)
...
[![HAve CategoryName alanı DropDownList görüntülemek ve kullanmak CategoryID değeri](master-detail-filtering-with-a-dropdownlist-vb/_static/image14.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image13.png)
...
[![A Aşağı açılan geçerli kategorileri listeler](master-detail-filtering-with-a-dropdownlist-vb/_static/image17.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image16.png)
...
[![SGetProductsByCategoryID(categoryID) yöntemi seçmeniz](master-detail-filtering-with-a-dropdownlist-vb/_static/image20.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image19.png)
...
[![Set CategoryID parametresi için kategorileri DropDownList değeri](master-detail-filtering-with-a-dropdownlist-vb/_static/image23.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image22.png)
...
[![WMIN ilk sayfası, içecek ürünleri görüntülenen ziyaret](master-detail-filtering-with-a-dropdownlist-vb/_static/image26.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image25.png)
...
[![Sbir yeni ürün (ürün) otomatik olarak neden GridView güncelleştiriliyor, bir geri gönderme seçme](master-detail-filtering-with-a-dropdownlist-vb/_static/image29.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image28.png)
...
[![Add bir--bir kategori--liste öğesini seçin.](master-detail-filtering-with-a-dropdownlist-vb/_static/image32.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image31.png)
...
[![Oİlk sayfa yük Hayır ürünleri n görüntülenen](master-detail-filtering-with-a-dropdownlist-vb/_static/image36.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image35.png)
...
[![ATüm ürünler olan artık tarafından listelenen varsayılan](master-detail-filtering-with-a-dropdownlist-vb/_static/image39.png)](master-detail-filtering-with-a-dropdownlist-vb/_static/image38.png)
