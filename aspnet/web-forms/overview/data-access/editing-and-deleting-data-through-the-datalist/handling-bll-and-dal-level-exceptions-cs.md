...
title: BLL ve DAL düzeyi özel durumları işleme (C#) | Microsoft Docs
...
ms.locfileid: "74634093"
---
# <a name="handling-bll--and-dal-level-exceptions-c"></a>BLL ve DAL Düzeyi Özel Durumları İşleme (C#)

[Scott Mitchell](https://twitter.com/ScottOnWriting) tarafından

[Örnek uygulamayı indirin](https://download.microsoft.com/download/9/c/1/9c1d03ee-29ba-4d58-aa1a-f201dcc822ea/ASPNET_Data_Tutorial_38_CS.exe) veya [PDF 'yi indirin](handling-bll-and-dal-level-exceptions-cs/_static/datatutorial38cs1.pdf)
...
[![GetProducts () yöntemini kullanarak ürün bilgilerini döndürün](handling-bll-and-dal-level-exceptions-cs/_static/image2.png)](handling-bll-and-dal-level-exceptions-cs/_static/image1.png)

**Şekil 1**: `GetProducts()` yöntemini kullanarak ürün bilgilerini döndürün ([tam boyutlu görüntüyü görüntülemek için tıklayın](handling-bll-and-dal-level-exceptions-cs/_static/image3.png))
...
[![her ürün bir düzenleme düğmesi Içerir](handling-bll-and-dal-level-exceptions-cs/_static/image5.png)](handling-bll-and-dal-level-exceptions-cs/_static/image4.png)

**Şekil 2**: her ürün bir düzenleme düğmesi içerir ([tam boyutlu görüntüyü görüntülemek için tıklayın](handling-bll-and-dal-level-exceptions-cs/_static/image6.png))
...
![Işlenmeyen bir özel durum oluştuğunda, Son Kullanıcı bir hata sayfası görür](handling-bll-and-dal-level-exceptions-cs/_static/image7.png)
...
[Kullanıcı gerekli bir alanı atladığında bir hata Iletisi ![görüntülenir](handling-bll-and-dal-level-exceptions-cs/_static/image9.png)](handling-bll-and-dal-level-exceptions-cs/_static/image8.png)

**Şekil 4**: Kullanıcı gerekli bir alanı atladığında bir hata iletisi görüntülenir ([tam boyutlu görüntüyü görüntülemek için tıklatın](handling-bll-and-dal-level-exceptions-cs/_static/image10.png))

[Negatif fiyat girerken bir hata Iletisi ![görüntülenir](handling-bll-and-dal-level-exceptions-cs/_static/image12.png)](handling-bll-and-dal-level-exceptions-cs/_static/image11.png)

**Şekil 5**: negatif bir fiyat girerken bir hata iletisi görüntülenir ([tam boyutlu görüntüyü görüntülemek için tıklayın](handling-bll-and-dal-level-exceptions-cs/_static/image13.png))
