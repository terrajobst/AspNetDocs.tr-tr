...
[![Return GetProducts() yöntemi kullanılarak ürün bilgilerini](handling-bll-and-dal-level-exceptions-cs/_static/image2.png)](handling-bll-and-dal-level-exceptions-cs/_static/image1.png)
...
[![EÜrün ACH bir Düzenle düğmesi içeren](handling-bll-and-dal-level-exceptions-cs/_static/image5.png)](handling-bll-and-dal-level-exceptions-cs/_static/image4.png)
...
[![Abir kullanıcı gerekli bir alan atlar. n hata iletisi görüntülenir](handling-bll-and-dal-level-exceptions-cs/_static/image9.png)](handling-bll-and-dal-level-exceptions-cs/_static/image8.png)
...
[![An hata iletisi, görüntülenen zaman girme negatif bir fiyat](handling-bll-and-dal-level-exceptions-cs/_static/image12.png)](handling-bll-and-dal-level-exceptions-cs/_static/image11.png)
