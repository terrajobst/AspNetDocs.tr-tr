...
[![FPAS yeni sayfalar eklenmiştir üyelik klasörü](creating-user-accounts-cs/_static/image2.png)](creating-user-accounts-cs/_static/image1.png)
...
[![Add adlı bir dosya birtakım projenin kök dizini](creating-user-accounts-cs/_static/image5.png)](creating-user-accounts-cs/_static/image4.png)
...
[![To Site Haritası, hiyerarşik bir gezinti yapısı temsil eden](creating-user-accounts-cs/_static/image8.png)](creating-user-accounts-cs/_static/image7.png)
...
[![THe gezinme kullanıcı arabirimi oluşturulmasını kullanarak iç içe geçmiş sırasız listeler 's](creating-user-accounts-cs/_static/image11.png)](creating-user-accounts-cs/_static/image10.png)
...
[![TSite Haritası geçerli sayfa ve alt öğelerinden o içerik haritası görüntüler](creating-user-accounts-cs/_static/image14.png)](creating-user-accounts-cs/_static/image13.png)
...
[![AÇeşitli Web denetimleri CreatingUserAccounts.aspx sayfasına gg](creating-user-accounts-cs/_static/image17.png)](creating-user-accounts-cs/_static/image16.png)
...
[![A Yeni kullanıcı hesabı başarıyla oluşturuldu ise](creating-user-accounts-cs/_static/image20.png)](creating-user-accounts-cs/_static/image19.png)
...
[![TSağlanan parola çok zayıf olduğu için o kullanıcı hesabı oluşturulmaz](creating-user-accounts-cs/_static/image23.png)](creating-user-accounts-cs/_static/image22.png)
...
[![TKullanıcı adı zaten kullanımda olduğundan, bu kendisinin kullanıcı hesabı oluşturulmaz](creating-user-accounts-cs/_static/image26.png)](creating-user-accounts-cs/_static/image25.png)
...
[![TÜyelik kullanıcı Store içinde iki kullanıcı şunlardır: Tito ve Bruce](creating-user-accounts-cs/_static/image29.png)](creating-user-accounts-cs/_static/image28.png)
...
[![THe CreateUserWizard denetim genel bir oluşturma kullanıcı arabirimi oluşturur](creating-user-accounts-cs/_static/image32.png)](creating-user-accounts-cs/_static/image31.png)
...
[![THe CreateUserWizard otomatik olarak eklediği doğrulama denetimleri](creating-user-accounts-cs/_static/image35.png)](creating-user-accounts-cs/_static/image34.png)
...
[![A Yeni kullanıcı hesabı başarıyla oluşturuldu sahip](creating-user-accounts-cs/_static/image38.png)](creating-user-accounts-cs/_static/image37.png)
...
[![THe CreateUserWizardStep'e bir iptal düğmesi içeren](creating-user-accounts-cs/_static/image41.png)](creating-user-accounts-cs/_static/image40.png)
...
[![Usernames baştaki veya sondaki boşluklara izin verilmez](creating-user-accounts-cs/_static/image44.png)](creating-user-accounts-cs/_static/image43.png)
