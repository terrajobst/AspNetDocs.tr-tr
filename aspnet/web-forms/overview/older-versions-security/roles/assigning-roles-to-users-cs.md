...
[![THe etiketin CssClass özelliği sonuçları bir büyük kırmızı yazı tipi](assigning-roles-to-users-cs/_static/image2.png)](assigning-roles-to-users-cs/_static/image1.png)
...
[![THe sayfası, kullanıcıları ve rolleri görüntüler](assigning-roles-to-users-cs/_static/image5.png)](assigning-roles-to-users-cs/_static/image4.png)
...
[![Taslan denetçiler roller ve Yöneticiler için eklenmiş olan](assigning-roles-to-users-cs/_static/image8.png)](assigning-roles-to-users-cs/_static/image7.png)
...
[![Bruce denetçiler rolüne eklenmiş olan](assigning-roles-to-users-cs/_static/image11.png)](assigning-roles-to-users-cs/_static/image10.png)
...
[![THe rolleri RoleList DropDownList içinde görüntülenen](assigning-roles-to-users-cs/_static/image14.png)](assigning-roles-to-users-cs/_static/image13.png)
...
[![THe GridView, seçili Role ait kullanıcılarla listeler](assigning-roles-to-users-cs/_static/image17.png)](assigning-roles-to-users-cs/_static/image16.png)
...
[![AArtık bir yönetici Las, Tito değil](assigning-roles-to-users-cs/_static/image23.png)](assigning-roles-to-users-cs/_static/image22.png)
...
[![YOU varolmayan kullanıcı rol ekleyemezsiniz](assigning-roles-to-users-cs/_static/image26.png)](assigning-roles-to-users-cs/_static/image25.png)
...
[![Taslan yine bir denetleyicidir!](assigning-roles-to-users-cs/_static/image29.png)](assigning-roles-to-users-cs/_static/image28.png)
...
[![CAdlı yeni bir kullanıcı Wanda Oluştur](assigning-roles-to-users-cs/_static/image35.png)](assigning-roles-to-users-cs/_static/image34.png)
...
[![Myap Wanda denetçiler rolünün bir üyesi](assigning-roles-to-users-cs/_static/image38.png)](assigning-roles-to-users-cs/_static/image37.png)
...
[![BTüm denetçiler ruce Tito ve Wanda olan](assigning-roles-to-users-cs/_static/image41.png)](assigning-roles-to-users-cs/_static/image40.png)
