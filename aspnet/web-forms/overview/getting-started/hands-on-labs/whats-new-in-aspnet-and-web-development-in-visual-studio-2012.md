...
2. <span data-ttu-id="2a1f6-146">Çözüm Gezgini'nde açın **Site.css** altında bulunan dosya **stilleri** klasör.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-146">In Solution Explorer, open the **Site.css** file located under the **Styles** folder.</span></span> <span data-ttu-id="2a1f6-147">Emin **metin düzenleyici** araçları araç çubuğunda görünür.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-147">Make sure the **Text Editor** tools are visible on the toolbar.</span></span> <span data-ttu-id="2a1f6-148">Bunu yapmak için seçin **görünümü** | **araç çubukları** menü seçeneği ve onay **metin düzenleyici** seçenekleri.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-148">To do that, select the **View** | **Toolbars** menu option, and check the **Text Editor** options.</span></span> <span data-ttu-id="2a1f6-149">Bu yeni sürümün bu yana fark edeceksiniz **yorum** düğmesine (![Açıklama düğmesi](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image1.png) ) ve **açıklamayı Kaldır** düğmesine (![açıklamasını Kaldır düğmesine](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image2.png)) için CSS Düzenleyicisi de etkinleştirilir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-149">You will notice that, since this new version, the **Comment** button (![comment-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image1.png) ) and the **Uncomment** button (![uncomment-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image2.png) ) are also enabled for the CSS editor.</span></span>
    ...
    <span data-ttu-id="2a1f6-150">![Düzenleyici ve CSS araçları etkinleştirme](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image3.png "Düzenleyicisi ve CSS Araçları'nı etkinleştirme")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-150">![Enabling Editor and CSS Tools](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image3.png "Enabling Editor and CSS Tools")</span></span>
...
5. <span data-ttu-id="2a1f6-159">Akıllı girintileme özelliği etkin olduğundan emin olun.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-159">Make sure that the smart indentation feature is enabled.</span></span> <span data-ttu-id="2a1f6-160">Seçin **Araçları** | **seçenekleri** seçeneğine tıklayın ve ardından **metin düzenleyici** | **CSS**  |  **Biçimlendirme** ekranın sol bölmede sayfası.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-160">Select the **Tools** | **Options** menu option, and then select the **Text Editor** | **CSS** | **Formatting** page in the left pane of the screen.</span></span> <span data-ttu-id="2a1f6-161">Denetleme **hiyerarşik girintileme** seçeneği.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-161">Check the **Hierarchical indentation** option.</span></span>
    ...
    <span data-ttu-id="2a1f6-163">*Hiyerarşik girintileme etkinleştirme*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-163">*Enabling hierarchical indentation*</span></span>
...
4. <span data-ttu-id="2a1f6-189">İçinde **Opaklık** kaydırıcı, seçici opaklık azaltmak için çubuğunun merkezine taşımanızı.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-189">In the **Opacity** slider, move the selector to the center of the bar to reduce the opacity.</span></span> <span data-ttu-id="2a1f6-190">Arka plan renk değeri RGBA için artık, ölçeği değiştiğine dikkat edin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-190">Notice that background-color value now changes its scale to RGBA.</span></span>
    ...
    <span data-ttu-id="2a1f6-191">![Renk Seçici Opaklık](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image16.png "opaklık Renk Seçici")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-191">![Color picker Opacity](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image16.png "Color picker Opacity")</span></span>
...
1. <span data-ttu-id="2a1f6-197">İçinde **Site.css** bulun, dosya **üstbilgi** CSS sınıf tanımını (.header) ve aşağıdaki imleci **/ \*kenarlık RADIUS\* /** yeni bir kod parçacığı eklemek için yer tutucu.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-197">In the **Site.css** file, locate the **header** CSS class definition (.header) and place the cursor below the **/\*border radius\*/** placeholder to add a new snippet.</span></span> <span data-ttu-id="2a1f6-198">Tuşuna **Enter** türü ve IntelliSense listesini görüntülemek için **RADIUS** listeyi filtrelemek için.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-198">Press **Enter** to display the IntelliSense list and type **radius** to filter the list.</span></span> <span data-ttu-id="2a1f6-199">Seçin **border-radius** seçenek listesinden bir çift tıklamayla ve tuşuna **sekmesini** kod parçacığını eklemek için anahtar.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-199">Select the **border-radius** option from the list with a double click, and then press the **TAB** key to insert the snippet.</span></span> <span data-ttu-id="2a1f6-200">Ardından, bir RADIUS boyutunu piksel ve ENTER tuşuna yazın **Enter**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-200">Then, type a radius size in pixels and press **Enter**.</span></span> <span data-ttu-id="2a1f6-201">Örneğin, türü **15px**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-201">For instance, type **15px**.</span></span>
    ...
    <span data-ttu-id="2a1f6-204">*Border-radius kod parçacığını kullanarak*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-204">*Using a border-radius snippet*</span></span>
...
7. <span data-ttu-id="2a1f6-220">Yeni bir sınıf oluşturun **div.images ul li img:hover** aşağıda **div.images ul li img** sınıf tanımını ve imleci ayraçlar içinde **.**</span><span class="sxs-lookup"><span data-stu-id="2a1f6-220">Create a new class **div.images ul li img:hover** below the **div.images ul li img** class definition and place the cursor inside the brackets **.**</span></span>
    ...
    <span data-ttu-id="2a1f6-221">CSS</span><span class="sxs-lookup"><span data-stu-id="2a1f6-221">CSS</span></span>
...
7. <span data-ttu-id="2a1f6-260">İmlecin altındaki yerleştirmek **gövdesi** öğesi ve bir HTML5 öğe yeniden yazmaya (örneğin, gibi **video**).</span><span class="sxs-lookup"><span data-stu-id="2a1f6-260">Place the cursor under the **body** element and start typing an HTML5 element again (For example, like **video**).</span></span> <span data-ttu-id="2a1f6-261">HTML5 öğeleri IntelliSense listesinde kullanılabilir olduğuna dikkat edin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-261">Notice that the HTML5 elements are now available in the IntelliSense list.</span></span>
    ...
    <span data-ttu-id="2a1f6-262">![HTML5 öğeleri listelenmesini](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image26.png "listelenmesini HTML5 öğeleri")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-262">![HTML5 elements being listed](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image26.png "HTML5 elements being listed")</span></span>
...
1. <span data-ttu-id="2a1f6-304">Açık **Site.Master** bulun **asp: menü** öğesi.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-304">Open **Site.Master** and locate the **asp:Menu** element.</span></span> <span data-ttu-id="2a1f6-305">Başlangıç etiketi ve dikkat öğe - alt kısmında görüntülenen küçük simge Akıllı görevler menüsünü açmak için tıklayın imleci yerleştirin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-305">Place the cursor on the start tag and notice that the small glyph displayed at the bottom of the element - click it to open the smart tasks menu.</span></span> <span data-ttu-id="2a1f6-306">Menü denetimi ile ilgili bazı görevleri hızlı erişimi olduğunu fark edeceksiniz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-306">Notice that you have quick access to some tasks related to the Menu control.</span></span>
...
1. <span data-ttu-id="2a1f6-313">Indenting yapılandırma üzerinde HTML düzenleyicisi akıllı girintileme için ayarlanmış olduğundan emin olun.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-313">Make sure that the Indenting configuration on the HTML Editor is set to Smart Indentation.</span></span> <span data-ttu-id="2a1f6-314">Bunu yapmak için seçin **araçları | Seçenekleri** menü seçeneğini ve ardından **metin düzenleyicisi | HTML | Sekmeleri** ekranın sol bölmede sayfası.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-314">To do that, select the **Tools | Options** menu option and then select the **Text Editor | HTML | Tabs** page in the left pane of the screen.</span></span> <span data-ttu-id="2a1f6-315">Akıllı girintileme seçeneğini belirleyin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-315">Select the Smart indentation option.</span></span>
    ...
    <span data-ttu-id="2a1f6-317">*HTML düzenleyicisi ayarları*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-317">*HTML Editor settings*</span></span>
...
1. <span data-ttu-id="2a1f6-330">Üzerinde **Default.aspx** sayfasında **H2** ve **ses** öğeleri.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-330">On the **Default.aspx** page, select the **H2** and **audio** elements.</span></span>
...
6. <span data-ttu-id="2a1f6-367">Bir açma ayracı tıklayın (**{**) komut dosyası kodu ve köşeli ayraçlar vurgulanır dikkat edin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-367">Click any opening bracket (**{**) from the scripting code and notice that the brackets are highlighted.</span></span>
    ...
    <span data-ttu-id="2a1f6-369">*Köşeli ayraçlar vurgulanır*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-369">*Brackets are highlighted*</span></span>
...
1. <span data-ttu-id="2a1f6-379">Açık **ECMA5script5.js** altında bulunan **Scripts\custom** proje klasörü.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-379">Open **ECMA5script5.js** located under the **Scripts\custom** project folder.</span></span> <span data-ttu-id="2a1f6-380">Artık doğrulama ECMAScript5 standart için test eder.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-380">You will now test validation for ECMAScript5 standard.</span></span>
    ...
    <span data-ttu-id="2a1f6-381">Gözden geçirin &quot; **katı kullan** &quot; ECMAScript5 sağlayan dosyanın ilk satırı yönde **katı mod**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-381">You can check out the &quot; **use strict** &quot; direction in the first line of the file, which enables ECMAScript5 **strict mode**.</span></span> <span data-ttu-id="2a1f6-382">Bu modda, son sürümünden belirsizlikleri açıklar ve nesne özellikleri alıcılar ve ayarlayıcılar, JSON ve daha eksiksiz bir yansıma için kitaplık desteği gibi bazı yeni özellikler ekler dilini alt oluşur.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-382">This mode consists in a subset of the language that clarifies ambiguities from the past edition, and adds some new features, such as getters and setters, library support for JSON, and more complete reflection on object properties.</span></span>
2. <span data-ttu-id="2a1f6-383">Açık **hata listesi** zaten açtıysanız (**görünümü** menü | **Hata listesi**).</span><span class="sxs-lookup"><span data-stu-id="2a1f6-383">Open the **Error List** if not already opened (**View** menu | **Error List**).</span></span> <span data-ttu-id="2a1f6-384">Bildirim **işlevi** bildirimi çizilir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-384">Notice the **function** declaration is underlined.</span></span> <span data-ttu-id="2a1f6-385">Dil yapıları standart işlevleri ECMA5 içinde yuvalanamaz olmasıdır.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-385">This is because in ECMA5 standard functions cannot be nested inside language structures.</span></span> <span data-ttu-id="2a1f6-386">Hata, uyarı ayrıntıları, aşağıdaki listede görürsünüz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-386">In the error list below you will see the warning details.</span></span>

    <span data-ttu-id="2a1f6-387">![JavaScript doğrulama hatası iletisini](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image42.png "JavaScript doğrulama hata iletisi")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-387">![JavaScript validation error message](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image42.png "JavaScript validation error message")</span></span>

    <span data-ttu-id="2a1f6-388">*JavaScript doğrulama hata iletisi*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-388">*JavaScript validation error message*</span></span>
3. <span data-ttu-id="2a1f6-389">Açıklama **&quot;katı kullan&quot;** yönünü ve hataları yok, ancak uyarılar kalır dikkat edin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-389">Comment out the **&quot;use strict&quot;** direction and notice that errors disappear, but the warnings remain.</span></span>
4. <span data-ttu-id="2a1f6-390">Dosyasının son satırında gibi herhangi bir dize yazmak **&quot;test&quot;** (dize olarak belirtmek için tırnak işaretleri dahil).</span><span class="sxs-lookup"><span data-stu-id="2a1f6-390">In the last line of the file, write any string like **&quot;test&quot;** (include the quotation marks to indicate it is as string).</span></span> <span data-ttu-id="2a1f6-391">Bir süre IntelliSense listesini görüntülemek ve seçmek için dize yanındaki yazma **trim** seçeneği.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-391">Write a period next to the string to display the IntelliSense list, and select the **trim** option.</span></span>

    <span data-ttu-id="2a1f6-392">ECMAScript5 standart, dize değerleri ve değişkenleri, trim, büyük harf, arama ve değiştirme gibi tanımlı dize yöntemlerini de.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-392">In ECMAScript5 standard, string values and variables also have string methods defined, like trim, uppercase, search and replace.</span></span>

    <span data-ttu-id="2a1f6-393">![JavaScript IntelliSense listesinde](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image43.png "JavaScript IntelliSense listesinde")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-393">![IntelliSense list in JavaScript](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image43.png "IntelliSense list in JavaScript")</span></span>

    <span data-ttu-id="2a1f6-394">*JavaScript IntelliSense listesinde*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-394">*IntelliSense list in JavaScript*</span></span>

<a id="Ex3Task3"></a>

<a id="Task_3_-_XML_Documentation_for_JavaScript"></a>
#### <a name="task-3---xml-documentation-for-javascript"></a><span data-ttu-id="2a1f6-395">Görev 3 - JavaScript XML belgeleri</span><span class="sxs-lookup"><span data-stu-id="2a1f6-395">Task 3 - XML Documentation for JavaScript</span></span>

<span data-ttu-id="2a1f6-396">Bu görevde, JavaScript XML belgelerinde için Visual Studio özellikleri inceleyeceksiniz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-396">In this task, you will explore Visual Studio features for XML documentation in JavaScript.</span></span> <span data-ttu-id="2a1f6-397">JavaScript IntelliSense listesini her işlevin XML belgeleri gösterdiğini görürsünüz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-397">You will see the JavaScript IntelliSense list now shows the XML documentation of each function.</span></span> <span data-ttu-id="2a1f6-398">Ayrıca, JavaScript gezinti özelliği keşfeder.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-398">Additionally, you will discover the navigation feature in JavaScript.</span></span>

1. <span data-ttu-id="2a1f6-399">Açık **XMLDoc.js** bulunan dosya **betikleri/özel** proje klasörü.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-399">Open **XMLDoc.js** file located in **Scripts/custom** project folder.</span></span> <span data-ttu-id="2a1f6-400">Bu dosya, XML belgeleri her JavaScript işlevleri içerir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-400">This file contains XML documentation on each of the JavaScript functions.</span></span>

    <span data-ttu-id="2a1f6-401">![JavaScript XML belgeleri için IntelliSense tümleşik](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image44.png "JavaScript XML belgeleri için IntelliSense tümleşik")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-401">![JavaScript XML documentation integrated to IntelliSense](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image44.png "JavaScript XML documentation integrated to IntelliSense")</span></span>

    <span data-ttu-id="2a1f6-402">*IntelliSense için tümleşik JavaScript XML belgeleri*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-402">*JavaScript XML documentation integrated to IntelliSense*</span></span>
2. <span data-ttu-id="2a1f6-403">Aşağıda **ekleme** işlevi **XMLDoc.js** dosya, adlı yeni bir işlev oluşturma **test**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-403">Below **add** function in **XMLDoc.js** file, create a new function named **test**.</span></span>
3. <span data-ttu-id="2a1f6-404">İçinde **test** işlev, çağrı **Çarp** iki parametre alan bir işlev.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-404">In the **test** function, call the **multiply** function that receives two parameters.</span></span> <span data-ttu-id="2a1f6-405">Araç İpucu kutuyu gösteren fark **Çarp** işlevi belgelerine.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-405">Notice the tooltip box is showing the **multiply** function documentation.</span></span>

    [!code-javascript[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample9.js)]

    <span data-ttu-id="2a1f6-406">![JavaScript işlevleri için XML belgeleri](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image45.png "XML belgeleri için JavaScript işlevleri")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-406">![XML documentation for JavaScript functions](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image45.png "XML documentation for JavaScript functions")</span></span>

    <span data-ttu-id="2a1f6-407">*XML belgeleri için JavaScript işlevleri*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-407">*XML documentation for JavaScript functions*</span></span>
4. <span data-ttu-id="2a1f6-408">İşlev çağrısı ifadesi ve türü tamamlamak bir *nokta* döndürülen değerin üzerinde IntelliSense listesini açın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-408">Complete the function call statement and type a *dot* to open the IntelliSense list on the returned value.</span></span> <span data-ttu-id="2a1f6-409">Visual Studio algılama Uyarısı **dönüş** değeri bir sayı olarak davranılması belgelerinde değeri.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-409">Notice that Visual Studio is detecting the **return** value in the documentation, treating the value as a number.</span></span>

    <span data-ttu-id="2a1f6-410">![Dönüş türleri için XML belgeleri](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image46.png "dönüş türleri için XML belgeleri")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-410">![XML documentation for return types](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image46.png "XML documentation for return types")</span></span>

    <span data-ttu-id="2a1f6-411">*Dönüş türleri için XML belgeleri*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-411">*XML documentation for return types*</span></span>
5. <span data-ttu-id="2a1f6-412">Şimdi, işlev eklemek için bir çağrı ekleyin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-412">Now, insert a call to add function.</span></span> <span data-ttu-id="2a1f6-413">JavaScript Düzenleyici artık işlev aşırı yüklemelerinin içerdiğine dikkat edin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-413">Notice that the JavaScript editor now supports function overloads.</span></span> <span data-ttu-id="2a1f6-414">Bir işlev adı yazdığınızda, herhangi bir belgede belirtilen kullanılabilir aşırı olacaktır.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-414">When you write a function name, you will be able to select any of the available overloads specified in the documentation.</span></span>

    <span data-ttu-id="2a1f6-415">![XML belgeleri için aşırı yüklemeleri](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image47.png "aşırı yüklemeler için XML belgeleri")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-415">![XML documentation for overloads](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image47.png "XML documentation for overloads")</span></span>

    <span data-ttu-id="2a1f6-416">*Aşırı yüklemeler için XML belgeleri*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-416">*XML documentation for overloads*</span></span>
6. <span data-ttu-id="2a1f6-417">Açık **GotoDefinition.js** bulun ve dosya **$().html()** işlev çağrısı.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-417">Open **GotoDefinition.js** file and locate the **$().html()** function call.</span></span> <span data-ttu-id="2a1f6-418">İmleç bulmak **html**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-418">Locate the cursor on **html**.</span></span>
7. <span data-ttu-id="2a1f6-419">Tuşuna **F12** ve tanımına gidin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-419">Press **F12** and navigate to the definition.</span></span> <span data-ttu-id="2a1f6-420">Artık erişebilir ve kullanmadan JavaScript kodunuza göz atma bildirimi **Bul** aracı.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-420">Notice you can now access and browse your JavaScript code without using the **Find** tool.</span></span>
8. <span data-ttu-id="2a1f6-421">İmleci, kod dosyasının sonundaki imza bloğunu önce jQuery yönerge üzerinde bulun.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-421">Locate the cursor on the jQuery instruction prior to the signature block at the bottom of the code file.</span></span> <span data-ttu-id="2a1f6-422">Tuşuna **F12**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-422">Press **F12**.</span></span> <span data-ttu-id="2a1f6-423">JQuery kitaplığı dosyaya gider.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-423">You will navigate to the jQuery library file.</span></span> <span data-ttu-id="2a1f6-424">JQuery kullanarak dosyaları arasında da gidebilirsiniz fark **F12**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-424">Notice you can also navigate across the jQuery files using **F12**.</span></span>

    <span data-ttu-id="2a1f6-425">![JQuery tanımları için gezinme](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image48.png "jQuery tanımları için gezinme")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-425">![Navigating to jQuery definitions](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image48.png "Navigating to jQuery definitions")</span></span>

    <span data-ttu-id="2a1f6-426">*JQuery tanımları için gezinme*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-426">*Navigating to jQuery definitions*</span></span>

> [!NOTE]
> <span data-ttu-id="2a1f6-427">Dosyayı kaydetmeden önce GotoDefinition.js söz dizimi hatası olduğundan emin olun.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-427">Make sure that GotoDefinition.js has no syntax errors before saving the file.</span></span>


<a id="Exercise4"></a>

<a id="Exercise_4_Bundling_and_Minification"></a>
### <a name="exercise-4-bundling-and-minification"></a><span data-ttu-id="2a1f6-428">Alıştırma 4: Paketleme ve Küçültme</span><span class="sxs-lookup"><span data-stu-id="2a1f6-428">Exercise 4: Bundling and Minification</span></span>

<span data-ttu-id="2a1f6-429">Kaç kez sitelerinizi birden fazla JavaScript ya da CSS dosyası dahil midir?</span><span class="sxs-lookup"><span data-stu-id="2a1f6-429">How many times do your websites include more than one JavaScript or CSS file?</span></span> <span data-ttu-id="2a1f6-430">Bu, burada paketleme ve küçültme dosya boyutunu azaltıp daha hızlı gerçekleştirin sitesini yardımcı olabilir, yaygın bir senaryodur.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-430">This is a very common scenario where bundling and minification can help to reduce the file size and make the site perform faster.</span></span> <span data-ttu-id="2a1f6-431">Yeni paket özelliği ASP.NET 4.5, tek bir öğe JS ya da CSS dosyaları paketleri ve içeriği (yani gerekli boşluk kaldırma açıklamaları kaldırma, tanımlayıcılar azaltma) küçültme tarafından boyutunu azaltır.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-431">The new bundling feature in ASP.NET 4.5 packs a set of JS or CSS files into a single element, and reduces its size by minifying the content ( i.e. removing not required blank spaces, removing comments, reducing identifiers ).</span></span>

<span data-ttu-id="2a1f6-432">Paketleme ve küçültme ASP.NET 4.5 içinde gerçekleştirilir çalışma zamanında işlemi kullanıcı aracısı (örneğin, IE, Mozilla, vb.) tanımlamak ve bu nedenle, kullanıcı tarayıcı (Mozilla belirli olan örneği için kaldırma öğe hedefleyerek sıkıştırma geliştirin ne zaman istek IE gelir).</span><span class="sxs-lookup"><span data-stu-id="2a1f6-432">Bundling and minification in ASP.NET 4.5 is performed at runtime, so that the process can identify the user agent (for example IE, Mozilla, etc), and thus, improve the compression by targeting the user browser (for instance, removing stuff that is Mozilla specific when the request comes from IE).</span></span>

<span data-ttu-id="2a1f6-433">Bu alıştırmada, etkinleştirmek ve paketleme ve küçültme farklı türde ASP.NET 4.5 içinde kullanmak öğreneceksiniz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-433">In this exercise, you will learn how to enable and use the different types of bundling and minification in ASP.NET 4.5.</span></span>

<a id="Ex4Task1"></a>

<a id="Task_1_-_Installing_the_Bundling_and_Minification_Package_from_NuGet"></a>
#### <a name="task-1---installing-the-bundling-and-minification-package-from-nuget"></a><span data-ttu-id="2a1f6-434">Görev 1 - yükleme paketleme ve küçültme NuGet paketi</span><span class="sxs-lookup"><span data-stu-id="2a1f6-434">Task 1 - Installing the Bundling and Minification Package from NuGet</span></span>

1. <span data-ttu-id="2a1f6-435">Henüz açık değilse başlatmak **Visual Studio** açın **WhatsNewASPNET.sln** çözüm bulunan **Source\WhatsNewASPNET** klasör, bu Laboratuvarın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-435">If not already opened, start **Visual Studio** and open the **WhatsNewASPNET.sln** solution located in the **Source\WhatsNewASPNET** folder of this lab.</span></span>
2. <span data-ttu-id="2a1f6-436">NuGet Paket Yöneticisi konsolunu açın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-436">Open the NuGet Package Manager Console.</span></span> <span data-ttu-id="2a1f6-437">Bunu yapmak için menüyü kullanın. **görünümü** | **diğer Windows** | **Paket Yöneticisi Konsolu**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-437">To do this, use the menu **View** | **Other Windows** | **Package Manager Console**.</span></span>

    <span data-ttu-id="2a1f6-438">![Paket Yöneticisi file:///C:/Users/User/AppData/Local/Temp/Marker3744//media/44462/Multiple-Stylesheets-and-JavaScript-files-in-the-application.pngconsole açma](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image49.png "Paket Yöneticisi konsolu açma")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-438">![Opening the package manager file:///C:/Users/User/AppData/Local/Temp/Marker3744//media/44462/Multiple-Stylesheets-and-JavaScript-files-in-the-application.pngconsole](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image49.png "Opening the package manager console")</span></span>

    <span data-ttu-id="2a1f6-439">*Paket Yöneticisi konsolu açma*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-439">*Opening the package manager console*</span></span>
3. <span data-ttu-id="2a1f6-440">İçinde **Paket Yöneticisi Konsolu** türü **Install-Package Microsoft.Web.Optimization** basın **ENTER**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-440">In the **Package Manager Console,** type **Install-Package Microsoft.Web.Optimization** and press **ENTER**.</span></span>

<a id="Ex4Task2"></a>

<a id="Task_2_-_Default_Bundles"></a>
#### <a name="task-2---default-bundles"></a><span data-ttu-id="2a1f6-441">Görev 2 - varsayılan paketleri</span><span class="sxs-lookup"><span data-stu-id="2a1f6-441">Task 2 - Default Bundles</span></span>

<span data-ttu-id="2a1f6-442">Paketleme ve küçültme kullanmanın en basit yolu, varsayılan paketleri etkinleştirmektir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-442">The simplest way to use bundling and minification is to enable the default bundles.</span></span> <span data-ttu-id="2a1f6-443">Bu yöntem, bir klasördeki JS ve CSS dosyaları ile birlikte gelen ve küçültülmüş sürümü başvuru izin vermek için kuralları kullanır.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-443">This method uses conventions to let you reference the bundled and minified version for the JS and CSS files in a folder.</span></span>

<span data-ttu-id="2a1f6-444">Bu görevde, etkinleştirmek ve paketlenmiş ve küçültülmüş JS ve CSS dosyalarına başvuruda ve elde edilen çıkış görüntülemeyi öğreneceksiniz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-444">In this task, you will learn how to enable and reference the bundled and minified JS and CSS files and view the resulting output.</span></span>

1. <span data-ttu-id="2a1f6-445">Henüz açık değilse başlatmak **Visual Studio** açın **WhatsNewASPNET.sln** çözüm bulunan **Source\WhatsNewASPNET** klasör, bu Laboratuvarın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-445">If not already opened, start **Visual Studio** and open the **WhatsNewASPNET.sln** solution located in the **Source\WhatsNewASPNET** folder of this lab.</span></span>
2. <span data-ttu-id="2a1f6-446">İçinde **Çözüm Gezgini**, genişletme **stilleri**, **Scripts\custom** ve **Scripts\bundle** klasörleri.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-446">In the **Solution Explorer**, expand the **Styles**, **Scripts\custom** and **Scripts\bundle** folders.</span></span>

    <span data-ttu-id="2a1f6-447">Uygulama birden fazla CSS ve JS dosyası kullandığını unutmayın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-447">Notice that the application is using more than one CSS and JS file.</span></span>

    <span data-ttu-id="2a1f6-448">![Uygulama birden çok stil sayfaları ve JavaScript dosyalarında](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image50.png "uygulamadaki birden çok stil sayfaları ve JavaScript dosyaları")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-448">![Multiple Stylesheets and JavaScript files in the application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image50.png "Multiple Stylesheets and JavaScript files in the application")</span></span>

    <span data-ttu-id="2a1f6-449">*Uygulama birden çok stil sayfaları ve JavaScript dosyaları*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-449">*Multiple Stylesheets and JavaScript files in the application*</span></span>
3. <span data-ttu-id="2a1f6-450">Açık **Global.asax.cs** dosya.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-450">Open the **Global.asax.cs** file.</span></span>

    <span data-ttu-id="2a1f6-451">Dikkat yeni **Microsoft.Web.Optimization** ad alanı dışında bırakılır dosyasının başında.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-451">Notice that the new **Microsoft.Web.Optimization** namespace is commented out at the beginning of the file.</span></span> <span data-ttu-id="2a1f6-452">Using açıklamadan çıkarın paketleme ve küçültme özelliklerinin yönergesi.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-452">Uncomment the using directive to include the bundling and minification features.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample10.cs)]
4. <span data-ttu-id="2a1f6-453">Bulun **uygulama\_Başlat** yöntemi.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-453">Locate the **Application\_Start** method.</span></span>

    <span data-ttu-id="2a1f6-454">Bu yöntemde, aşağıdaki kod parçacığında gösterildiği gibi EnableDefaultBundles çağrı açıklamasını kaldırın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-454">In this method, uncomment the EnableDefaultBundles call as shown in the snippet below.</span></span> <span data-ttu-id="2a1f6-455">Bu, klasörün yolunu kullanarak bir klasördeki CSS dosyaları ile birlikte gelen koleksiyonu başvuru sağlıyor artı &quot;CSS&quot; veya &quot;JS&quot; soneki.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-455">This enables us to reference a bundled collection of CSS files in a folder by using the path to that folder, plus the &quot;CSS&quot; or the &quot;JS&quot; suffix.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample11.cs)]
5. <span data-ttu-id="2a1f6-456">Açık **Optimization.aspx** dosya ve bulmak için içerik denetimi **HeadContent**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-456">Open the **Optimization.aspx** file and locate the content control for **HeadContent**.</span></span>

    <span data-ttu-id="2a1f6-457">CSS dosyaları ve tek bir başvurulan etikete sahip JS dosyaları dikkat edin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-457">Notice the CSS files and the JS files have a single referenced tag.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample12.aspx)]

    > [!NOTE]
    > <span data-ttu-id="2a1f6-458">Bu kod, tanıtım amaçları içindir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-458">This code is for demo purposes.</span></span> <span data-ttu-id="2a1f6-459">İdeal olarak, paketleri Site.Master dosyasına başvurur.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-459">Ideally, you will reference the bundles in the Site.Master file.</span></span> <span data-ttu-id="2a1f6-460">Bu örnek kodda, bazı paketlenen dosyalar da Site.Master dosyası tarafından başvurulmayan, bu son başvuru yedekli yaparak bulabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-460">In this sample code, you will find that some of the bundled files are also being referenced by the Site.Master file, making this last reference redundant.</span></span>
6. <span data-ttu-id="2a1f6-461">Bağlantıları paketleme kuralları kullanmakta olduğunu fark **href** stilleri ve Scripts\custom tüm CSS ve JS dosyaları almak için öznitelik klasör sırasıyla.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-461">Notice that the links are using the bundling conventions in the **href** attribute to get all the CSS or JS files from the Styles and Scripts\custom folder respectively.</span></span>

    <span data-ttu-id="2a1f6-462">Yol kullanabilirsiniz **betikleri/özel/JS** paketleme ve küçültme içindeki tüm JS dosyaları için aşağıda gösterildiği gibi bir **betikleri/özel** klasör.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-462">You can use the path **Scripts/custom/JS** as shown below to bundle and minify all the JS files inside a **Scripts/custom** folder.</span></span> <span data-ttu-id="2a1f6-463">Bu varsayılan paketlerle varsayılan davranıştır.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-463">This is the default behavior with the default bundles.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample13.aspx)]
7. <span data-ttu-id="2a1f6-464">Açık **Styles\Site.css** dosya.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-464">Open the **Styles\Site.css** file.</span></span>

    <span data-ttu-id="2a1f6-465">Özgün CSS dosyası girintili kodu, boşluk ve dosya büyütme açıklamaları içerdiğine dikkat edin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-465">Notice that the original CSS file contains indented code, blank spaces and comments that enlarge the file.</span></span> <span data-ttu-id="2a1f6-466">(Ayrıca JavaScript dosyası boş alanları ve açıklama içerir).</span><span class="sxs-lookup"><span data-stu-id="2a1f6-466">(Also the JavaScript file contains blank spaces and comments).</span></span>

    <span data-ttu-id="2a1f6-467">![Bir özgün CSS dosyaları betikler klasörüne](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image51.png "biri özgün CSS, betikler klasörüne dosyalar")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-467">![One of the original CSS files in the Scripts folder](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image51.png "One of the original CSS files in the Scripts folder")</span></span>

    <span data-ttu-id="2a1f6-468">*Özgün Scripts klasörü CSS dosyalarından birini*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-468">*One of the original CSS files in the Scripts folder*</span></span>
8. <span data-ttu-id="2a1f6-469">Tuşuna **F5** gidin ve uygulamayı çalıştırmak için **iyileştirme** sayfası.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-469">Press **F5** to run the application and navigate to the **Optimization** page.</span></span>
9. <span data-ttu-id="2a1f6-470">Tıklayarak **CSS paket** bağlantısını indirin ve dosyayı açın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-470">Click on the **CSS Bundle** link to download and open the file.</span></span>

    <span data-ttu-id="2a1f6-471">Küçültülmüş paketlenmiş dosyasını gözden geçirin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-471">Check out the minified bundled file.</span></span> <span data-ttu-id="2a1f6-472">Daha küçük bir dosya oluşturma tüm boşluk, açıklamalar ve girinti karakterler kaldırılmış olduğunu göreceksiniz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-472">You will notice that all the blank spaces, comments and indentation characters have been removed, generating a smaller file.</span></span>

    <span data-ttu-id="2a1f6-473">![CSS dosyaları paketlenmiş](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image52.png "paketlenmiş CSS dosyaları")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-473">![Bundled CSS files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image52.png "Bundled CSS files")</span></span>

    <span data-ttu-id="2a1f6-474">*Paketlenmiş CSS dosyaları*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-474">*Bundled CSS files*</span></span>
10. <span data-ttu-id="2a1f6-475">Artık tıklayın **JS paket** paketlenmiş bir JavaScript dosyasını açmaya yönelik bağlantı.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-475">Now click the **JS Bundle** link to open the JavaScript bundled file.</span></span> <span data-ttu-id="2a1f6-476">Uyarı Gezgini güvenle yoksayabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-476">You can safely disregard the explorer warning.</span></span> <span data-ttu-id="2a1f6-477">JavaScript dosyaları altındaki fark **özel** klasör Ayrıca paket ve küçültülmüş.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-477">Notice the JavaScript files under the **custom** folder are also bundled and minified.</span></span>

    <span data-ttu-id="2a1f6-478">![JavaScript dosyaları paketlenmiş](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image53.png "paketlenmiş JavaScript dosyaları")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-478">![Bundled JavaScript files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image53.png "Bundled JavaScript files")</span></span>

    <span data-ttu-id="2a1f6-479">*İle birlikte gelen JavaScript dosyaları*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-479">*Bundled JavaScript files*</span></span>

    <span data-ttu-id="2a1f6-480">CSS veya JS dosyaları için sıkıştırmanın etkinleştirilmesi ASP.NET önceki bir sürümünde çok daha karmaşıktır.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-480">Enabling compression for CSS or JS files was much more complicated in previous ASP.NET version.</span></span> <span data-ttu-id="2a1f6-481">Gördüğünüz gibi artık, bir satır eklemek yeterlidir *Global.asax* paketleme etkinleştirmek için dosya ve ardından sitenizdeki paketlenen dosyalar başvuru.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-481">Now, as you have seen, you just need to add one line in the *Global.asax* file to enable bundling, and then reference the bundled files from your site.</span></span>

<a id="Ex4Task3"></a>

<a id="Task_3_-_Static_Bundles"></a>
#### <a name="task-3---static-bundles"></a><span data-ttu-id="2a1f6-482">Görev 3 - statik paket</span><span class="sxs-lookup"><span data-stu-id="2a1f6-482">Task 3 - Static Bundles</span></span>

<span data-ttu-id="2a1f6-483">Statik paket yaklaşım paket, başvuru ve kullanılacak küçültme yöntemi dosya kümesini özelleştirmenizi sağlar.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-483">The static bundle approach allows you to customize the set of files to bundle, the reference and the minification method that will be used.</span></span>

<span data-ttu-id="2a1f6-484">Bu görevde, dosyaları paketleme ve küçültme belirli bir kümesini tanımlamak için statik bir paket yapılandıracaksınız.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-484">In this task, you will configure a static bundle to define a specific set of files to bundle and minify.</span></span>

1. <span data-ttu-id="2a1f6-485">Tarayıcıyı kapatın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-485">Close the browser.</span></span>
2. <span data-ttu-id="2a1f6-486">Açık **Global.asax.cs** bulun ve dosya **uygulama\_Başlat** yöntemi.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-486">Open the **Global.asax.cs** file and locate the **Application\_Start** method.</span></span>
3. <span data-ttu-id="2a1f6-487">Aşağıdaki kodda gösterildiği gibi statik paket kodun açıklamasını kaldırın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-487">Uncomment the static bundle code as shown in the code below.</span></span>

    <span data-ttu-id="2a1f6-488">İle başvurulan statik bir paket tanımlama &quot; **~/StaticBundle** &quot; sanal yolunu ve kullanım **JsMinify** küçültme ile belirtilen tüm dosyaların için **AddFile** yöntemi.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-488">You are defining a static bundle that will be referenced with the &quot;**~/StaticBundle**&quot; virtual path and use **JsMinify** for minification of all the specified files with the **AddFile** method.</span></span> <span data-ttu-id="2a1f6-489">Son olarak, için statik paket ekliyoruz **BundleTable** ve onu etkinleştirme.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-489">Finally, you are adding the static bundle to the **BundleTable** and enabling it.</span></span>

    <span data-ttu-id="2a1f6-490">Dosyaları yerinde bulunmayan dikkat edin. Varsayılan paketleme üzerinden başka bir avantajı budur.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-490">Notice that the files are not located in the same place; this is another advantage over the default bundling.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample14.cs)]
4. <span data-ttu-id="2a1f6-491">Açık **Optimization.aspx** dosya.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-491">Open the **Optimization.aspx** file.</span></span>

    <span data-ttu-id="2a1f6-492">Dikkat bağlantısını **statik JS paket** bildirilen statik paket Global.asax.cs dosyasında yapılandırıldığında yolu kullanarak: **/StaticBundle**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-492">Notice that the link to **Static JS Bundle** is using the path you have declared when you configured the static bundle in the Global.asax.cs file: **/StaticBundle**.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample15.aspx)]
5. <span data-ttu-id="2a1f6-493">Tuşuna **F5** uygulamayı çalıştırın ve ardından gitmek **iyileştirme** sayfası.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-493">Press **F5** to run the application, and then navigate to the **Optimization** page.</span></span>
6. <span data-ttu-id="2a1f6-494">Tıklayarak **statik JS paket** dosyayı açmaya yönelik bağlantı.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-494">Click on the **Static JS Bundle** link to open the file.</span></span>

    <span data-ttu-id="2a1f6-495">Bildirim küçültülmüş JavaScript dosyası paketlenmiş emin olan statik paket dosyasının yolu altında yapılandırılan tüm JavaScript dosyaları için çıkış &quot;/StaticBundle&quot;.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-495">Notice that the minified bundled JavaScript file is the output for all the JavaScript files configured in the static bundle file under the path &quot;/StaticBundle&quot;.</span></span>

    <span data-ttu-id="2a1f6-496">![Statik JavaScript dosyaları paket](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image54.png "statik JavaScript dosyaları paket")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-496">![Static JavaScript files bundle](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image54.png "Static JavaScript files bundle")</span></span>

    <span data-ttu-id="2a1f6-497">*JavaScript dosyaları statik paket*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-497">*Static JavaScript files bundle*</span></span>
7. <span data-ttu-id="2a1f6-498">Tarayıcıyı kapatın ve Visual Studio'ya geri dönün.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-498">Close the browser and return to Visual Studio.</span></span>

<a id="Ex4Task4"></a>

<a id="Task_4_-_Dynamic_Folder_Bundles"></a>
#### <a name="task-4---dynamic-folder-bundles"></a><span data-ttu-id="2a1f6-499">Görev 4 - dinamik klasörü paketler</span><span class="sxs-lookup"><span data-stu-id="2a1f6-499">Task 4 - Dynamic Folder Bundles</span></span>

<span data-ttu-id="2a1f6-500">Bu görevde, dinamik klasörü paketler yapılandırma öğreneceksiniz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-500">In this task, you will learn how to configure dynamic folder bundles.</span></span> <span data-ttu-id="2a1f6-501">Dinamik paketleme, JavaScript ile derlenen dillerde statik JavaScript yanı sıra diğer dosyaları içerir ve bu nedenle, paketleme yürütülmeden önce bazı işlem yapmanız gerekmez güçtür.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-501">The power of dynamic bundling is that you can include static JavaScript, as well as other files in languages that compiles into JavaScript, and thus, require some processing before the bundling is executed.</span></span>

<span data-ttu-id="2a1f6-502">Bu örnekte, nasıl kullanılacağını öğreneceksiniz **DynamicFolderBundle** CofeeScript yazılmış olan dosyalar için dinamik bir paket oluşturmak için sınıf.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-502">In this example, you will learn how to use the **DynamicFolderBundle** class to create a dynamic bundle for files written in CofeeScript.</span></span> <span data-ttu-id="2a1f6-503">CofeeScript JavaScript ile derlenen ve daha basit bir söz dizimi, JavaScript kodu yazarak, JavaScript'in kısaltma ve okunabilirliği için sağlayan bir programlama dilidir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-503">CofeeScript is a programming language that compiles into JavaScript and provides a simpler syntax for writing JavaScript code, enhancing JavaScript's brevity and readability.</span></span>

1. <span data-ttu-id="2a1f6-504">Açık **Global.asax.cs** bulun ve dosya **uygulama\_Başlat** yöntemi.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-504">Open the **Global.asax.cs** file and locate the **Application\_Start** method.</span></span>
2. <span data-ttu-id="2a1f6-505">Aşağıdaki kodda gösterildiği gibi dinamik paket kodun açıklamasını kaldırın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-505">Uncomment the dynamic bundle code as shown in the code below.</span></span>

    <span data-ttu-id="2a1f6-506">Kullanacağı bir dinamik klasör paketi tanımladığınız **CoffeeMinify** yalnızca dosyalarla uygulanacak özel küçültme İşlemci &quot; **.coffee** &quot; uzantısı () CoffeeScript dosyaları).</span><span class="sxs-lookup"><span data-stu-id="2a1f6-506">You are defining a dynamic folder bundle that will use the **CoffeeMinify** custom minification processor that will only apply to the files with the &quot;**.coffee**&quot; extension (CoffeeScript files).</span></span> <span data-ttu-id="2a1f6-507">Gibi bir klasör içinde paket dosyalarını seçmek için arama deseni kullanabilirsiniz bildirimi '\*.coffee'.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-507">Notice that you can use a search pattern to select the files to bundle within a folder, like '\*.coffee'.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample16.cs)]
3. <span data-ttu-id="2a1f6-508">NuGet Paket Yöneticisi konsolunu açın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-508">Open the NuGet Package Manager Console.</span></span> <span data-ttu-id="2a1f6-509">Bunu yapmak için menüyü kullanın. **görünümü** | **diğer Windows** | **Paket Yöneticisi Konsolu**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-509">To do this, use the menu **View** | **Other Windows** | **Package Manager Console**.</span></span>
4. <span data-ttu-id="2a1f6-510">İçinde **Paket Yöneticisi Konsolu** türü **Install-Package CoffeeSharp** basın **ENTER**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-510">In the **Package Manager Console,** type **Install-Package CoffeeSharp** and press **ENTER**.</span></span>
5. <span data-ttu-id="2a1f6-511">Tıklayın **tüm dosyaları göster** düğmesine **Çözüm Gezgini** penceresi</span><span class="sxs-lookup"><span data-stu-id="2a1f6-511">Click the **Show All Files** button in the **Solution Explorer** window</span></span>

    <span data-ttu-id="2a1f6-512">![Tüm dosyaları gösteren](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image55.png "tüm dosyalar gösteriliyor")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-512">![Showing all files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image55.png "Showing all files")</span></span>

    <span data-ttu-id="2a1f6-513">*Tüm dosyalar gösteriliyor*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-513">*Showing all files*</span></span>
6. <span data-ttu-id="2a1f6-514">Sağ tıklayın **CoffeeMinify.cs** dosyası **Çözüm Gezgini** seçip **Proje Ekle**</span><span class="sxs-lookup"><span data-stu-id="2a1f6-514">Right click the **CoffeeMinify.cs** file in the **Solution Explorer** and select **Include in Project**</span></span>

    <span data-ttu-id="2a1f6-515">![CoffeeMinify.cs dosya projeye dahil et](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image56.png "CoffeeMinify.cs dosya projeye dahil et")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-515">![Include the CoffeeMinify.cs file in the project](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image56.png "Include the CoffeeMinify.cs file in the project")</span></span>

    <span data-ttu-id="2a1f6-516">*CoffeeMinify.cs dosya projeye dahil et*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-516">*Include the CoffeeMinify.cs file in the project*</span></span>
7. <span data-ttu-id="2a1f6-517">Açık **CoffeeMinify.cs** dosya.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-517">Open the **CoffeeMinify.cs** file.</span></span>

    <span data-ttu-id="2a1f6-518">Bu sınıf, CoffeeScript kodu derlemeden kaynaklanan JavaScript çıkışını küçültülecek JsMinify devralır.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-518">This class inherits from JsMinify to minify the JavaScript output resulting from the CoffeeScript code compilation.</span></span> <span data-ttu-id="2a1f6-519">CoffeeScript derleyici ilk JavaScript kodunu oluşturmak için çağırır ve sonuç kodunu küçültülecek JsMinify.Process yöntemi, gönderir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-519">It calls the CoffeeScript compiler to generate the JavaScript code first, and then it sends it to the JsMinify.Process method to minify the resulting code.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample17.cs)]
8. <span data-ttu-id="2a1f6-520">Açık **Script1.coffee** ve **Script2.coffee** dosyalarını **betikleri/paket** klasör.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-520">Open the **Script1.coffee** and **Script2.coffee** files from the **Scripts/bundle** folder.</span></span>

    <span data-ttu-id="2a1f6-521">Bu dosyaları paketleme CoffeeMinify sınıfıyla gerçekleştirilirken derlenecek CoffeScript kod içerir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-521">These files will include the CoffeScript code to be compiled while performing the bundling with the CoffeeMinify class.</span></span>

    <span data-ttu-id="2a1f6-522">Kolaylık olması amacıyla sağlanan CoffeeScript dosyaları yalnızca CoffeeScript örnek kod dahil.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-522">For simplicity purposes, the CoffeeScript files provided are only including CoffeeScript sample code.</span></span> <span data-ttu-id="2a1f6-523">Yorumları JsMinify işlem tarafından bırakılır.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-523">The comments are excluded by the JsMinify process.</span></span>

    <span data-ttu-id="2a1f6-524">![CoffeeScript dosyaları](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image57.png "CoffeeScript dosyaları")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-524">![CoffeeScript files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image57.png "CoffeeScript files")</span></span>

    <span data-ttu-id="2a1f6-525">*CoffeeScript dosyaları*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-525">*CoffeeScript files*</span></span>

    > [!NOTE]
    > <span data-ttu-id="2a1f6-526">[CofeeScript](https://github.com/jashkenas/coffeescript/) JavaScript kodu yazarak, JavaScript'in kısaltma ve okunabilirliği, hem de dizi kavrama ve desen eşleştirme gibi diğer özellikler eklemek için daha basit bir söz dizimi sağlar.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-526">[CofeeScript](https://github.com/jashkenas/coffeescript/) provides a simpler syntax for writing JavaScript code, enhancing JavaScript's brevity and readability, as well as adding other features like array comprehension and pattern matching.</span></span>
9. <span data-ttu-id="2a1f6-527">Açık **Optimization.aspx** dosya ve paket bağlantıları bulun.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-527">Open the **Optimization.aspx** file and locate the bundle links.</span></span>

    <span data-ttu-id="2a1f6-528">Dikkat bağlantısını **dinamik JS paket** başvuruyor **betikleri/paket** kullanarak klasörüne **/kahve** dinamik klasör paketi için yapılandırılmış soneki.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-528">Notice that the link to **Dynamic JS Bundle** is referencing the **Scripts/bundle** folder by using the **/Coffee** suffix you configured for the dynamic folder bundle.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample18.aspx)]
10. <span data-ttu-id="2a1f6-529">Tuşuna **F5** uygulamayı çalıştırın ve ardından gitmek **iyileştirme** sayfası.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-529">Press **F5** to run the application, and then navigate to the **Optimization** page.</span></span>
11. <span data-ttu-id="2a1f6-530">Tıklayarak **dinamik JS paket** oluşturulan dosyasını açmaya yönelik bağlantı.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-530">Click on the **Dynamic JS Bundle** link to open the generated file.</span></span>

    <span data-ttu-id="2a1f6-531">Yalnızca bu pakete eklenen içeriği içeren bir bildirim **.coffee** dosyaları.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-531">Notice that the content that was included in this bundle only contains **.coffee** files.</span></span> <span data-ttu-id="2a1f6-532">CoffeeScript kod için JavaScript derlenen ve derleme dışı bırakılan satırlar kaldırıldı de görebilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-532">You can also see that the CoffeeScript code was compiled to JavaScript and the commented-out lines has been removed.</span></span>

    <span data-ttu-id="2a1f6-533">![Dinamik JS dosyaları paket](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image58.png "dinamik JS dosyaları paket")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-533">![Dynamic JS files bundle](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image58.png "Dynamic JS files bundle")</span></span>

    <span data-ttu-id="2a1f6-534">*Dinamik JS dosyaları paket*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-534">*Dynamic JS files bundle*</span></span>

> [!NOTE]
> <span data-ttu-id="2a1f6-535">Ayrıca, bu uygulama için Windows Azure Web siteleri aşağıdaki dağıtabilirsiniz [ek B: Bir ASP.NET MVC 4 Web dağıtımı kullanarak uygulama yayımlama](#AppendixB).</span><span class="sxs-lookup"><span data-stu-id="2a1f6-535">Additionally, you can deploy this application to Windows Azure Web Sites following [Appendix B: Publishing an ASP.NET MVC 4 Application using Web Deploy](#AppendixB).</span></span>


<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="2a1f6-536">Özet</span><span class="sxs-lookup"><span data-stu-id="2a1f6-536">Summary</span></span>

<span data-ttu-id="2a1f6-537">Bu Laboratuvar, ASP.NET ve Web geliştirme Visual Studio 2012'deki yenilikler ve Visual Studio 2012'de çeşitli geliştirmeler yararlanmak nasıl anlamanıza yardımcı olur.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-537">This lab helps you to understand what New in ASP.NET and Web Development in Visual Studio 2012 is and how to take advantage of the variety of enhancements in Visual Studio 2012.</span></span>

<span data-ttu-id="2a1f6-538">Bu uygulamalı laboratuvarı tamamlayarak yeni özellikler ve geliştirmeler, CSS, JavaScript ve HTML için Visual Studio 2012 düzenleyicilerde kullanma modellerin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-538">By completing this Hands-On Lab, you have learnt how to use the new features and improvements in Visual Studio 2012 Editors for CSS, JavaScript and HTML.</span></span> <span data-ttu-id="2a1f6-539">Ayrıca, Visual Studio 2012 yerleşik paketleme ve küçültme nasıl uyguladığını modellerin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-539">In addition, you have learnt how Visual Studio 2012 implements built-in bundling and minification.</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="2a1f6-540">Ek A: Web için Express 2012 Visual Studio'yu yükleme</span><span class="sxs-lookup"><span data-stu-id="2a1f6-540">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="2a1f6-541">Yükleyebileceğiniz **Web için Visual Studio Express 2012 Microsoft** veya başka bir &quot;Express&quot; sürümüyle **[Microsoft Web Platformu yükleyicisi](https://www.microsoft.com/web/downloads/platform.aspx)**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-541">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="2a1f6-542">Aşağıdaki yönergeler, yüklemek için gereken adımlarda size kılavuzluk *Web için Visual studio Express 2012* kullanarak *Microsoft Web Platformu yükleyicisi*.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-542">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="2a1f6-543">Git [ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="2a1f6-543">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="2a1f6-544">Web Platformu Yükleyicisi'ı zaten yüklediyseniz, bunun yerine ve ürün için arama açabileceğiniz &quot; <em>Visual Studio Express 2012 için Windows Azure SDK ile Web</em>&quot;.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-544">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Windows Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="2a1f6-545">Tıklayarak **Şimdi Yükle**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-545">Click on **Install Now**.</span></span> <span data-ttu-id="2a1f6-546">Yoksa **Web Platformu yükleyicisi** indirmek ve ilk yüklemek için yönlendirilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-546">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="2a1f6-547">Bir kez **Web Platformu yükleyicisi** açık tıklayın **yükleme** Kurulum'u başlatmak için.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-547">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="2a1f6-548">![Visual Studio Express yükleyin](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image59.png "Visual Studio Express'i yükle")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-548">![Install Visual Studio Express](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image59.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="2a1f6-549">*Visual Studio Express yükleyin*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-549">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="2a1f6-550">Tüm ürünlerin lisans ve koşulları okuyun ve tıklayın **kabul ediyorum** devam etmek için.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-550">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![Lisans koşullarını kabul etme](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image60.png)

    <span data-ttu-id="2a1f6-552">*Lisans koşullarını kabul etme*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-552">*Accepting the license terms*</span></span>
5. <span data-ttu-id="2a1f6-553">İndirme ve yükleme işlemi tamamlanana kadar bekleyin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-553">Wait until the downloading and installation process completes.</span></span>

    ![Yükleme ilerleme durumu](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image61.png)

    <span data-ttu-id="2a1f6-555">*Yükleme ilerleme durumu*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-555">*Installation progress*</span></span>
6. <span data-ttu-id="2a1f6-556">Yükleme tamamlandığında, tıklayın **son**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-556">When the installation completes, click **Finish**.</span></span>

    ![Yükleme tamamlandı](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image62.png)

    <span data-ttu-id="2a1f6-558">*Yükleme tamamlandı*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-558">*Installation completed*</span></span>
7. <span data-ttu-id="2a1f6-559">Tıklayın **çıkış** Web Platformu Yükleyicisi'ni kapatın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-559">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="2a1f6-560">Web için Visual Studio Express'te açmak için Git **Başlat** ekranında ve yazmaya başlayabilirsiniz &quot; **VS Express**&quot;, ardından **Web için VS Express** bir kutucuk.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-560">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![Web kutucuğu için VS Express](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image63.png)

    <span data-ttu-id="2a1f6-562">*Web kutucuğu için VS Express*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-562">*VS Express for Web tile*</span></span>
...
## <a name="appendix-b-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="2a1f6-563">Ek B: Bir ASP.NET MVC 4 Web dağıtımı kullanarak uygulama yayımlama</span><span class="sxs-lookup"><span data-stu-id="2a1f6-563">Appendix B: Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

<span data-ttu-id="2a1f6-564">Bu ekte, Windows Azure Yönetim Portalı'ndan yeni bir web sitesi oluşturun ve Laboratuvar izleyerek Windows Azure tarafından sağlanan Web dağıtımı Yayımlama özelliğini avantajlarını elde ettiğiniz uygulama yayımlama gösterilmektedir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-564">This appendix will show you how to create a new web site from the Windows Azure Management Portal and publish the application you obtained by following the lab, taking advantage of the Web Deploy publishing feature provided by Windows Azure.</span></span>

<a id="Ex1Task1"></a>

<a id="Task_1_-_Creating_a_New_Web_Site_from_the_Windows_Azure_Portal"></a>
#### <a name="task-1---creating-a-new-web-site-from-the-windows-azure-portal"></a><span data-ttu-id="2a1f6-565">Görev 1 Windows yeni bir Web sitesi oluşturma - Azure portalı</span><span class="sxs-lookup"><span data-stu-id="2a1f6-565">Task 1 - Creating a New Web Site from the Windows Azure Portal</span></span>

1. <span data-ttu-id="2a1f6-566">Git [Windows Azure Yönetim Portalı](https://manage.windowsazure.com/) aboneliğinizle ilişkili Microsoft kimlik bilgilerini kullanarak oturum açın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-566">Go to the [Windows Azure Management Portal](https://manage.windowsazure.com/) and sign in using the Microsoft credentials associated with your subscription.</span></span>

    > [!NOTE]
    > <span data-ttu-id="2a1f6-567">Windows Azure'la 10 ASP.NET Web sitesini ücretsiz olarak barındırın ve ardından trafiğiniz büyüdükçe ölçeğinizi artırın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-567">With Windows Azure you can host 10 ASP.NET Web Sites for free and then scale as your traffic grows.</span></span> <span data-ttu-id="2a1f6-568">Kaydolabilirsiniz [burada](https://aka.ms/aspnet-hol-azure).</span><span class="sxs-lookup"><span data-stu-id="2a1f6-568">You can sign up [here](https://aka.ms/aspnet-hol-azure).</span></span>

    <span data-ttu-id="2a1f6-569">![Windows Azure Portal'da oturum açın](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image64.png "Windows Azure Portal'da oturum açın")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-569">![Log on to Windows Azure portal](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image64.png "Log on to Windows Azure portal")</span></span>

    <span data-ttu-id="2a1f6-570">*Windows Azure yönetim portalında oturum açın*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-570">*Log on to Windows Azure Management Portal*</span></span>
2. <span data-ttu-id="2a1f6-571">Tıklayın **yeni** komut çubuğunda.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-571">Click **New** on the command bar.</span></span>

    <span data-ttu-id="2a1f6-572">![Yeni bir Web sitesi oluşturma](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image65.png "yeni bir Web sitesi oluşturma")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-572">![Creating a new Web Site](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image65.png "Creating a new Web Site")</span></span>

    <span data-ttu-id="2a1f6-573">*Yeni bir Web sitesi oluşturma*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-573">*Creating a new Web Site*</span></span>
3. <span data-ttu-id="2a1f6-574">Tıklayın **işlem** | **Web sitesi**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-574">Click **Compute** | **Web Site**.</span></span> <span data-ttu-id="2a1f6-575">Ardından **hızlı Oluştur** seçeneği.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-575">Then select **Quick Create** option.</span></span> <span data-ttu-id="2a1f6-576">Yeni web sitesi için kullanılabilen bir URL girin ve tıklatın **Web sitesi oluştur**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-576">Provide an available URL for the new web site and click **Create Web Site**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="2a1f6-577">Bir Windows Azure Web sitesi kontrol edebildiğiniz ve yönetebildiğiniz bulutta çalışan bir web uygulaması için ana bilgisayardır.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-577">A Windows Azure Web Site is the host for a web application running in the cloud that you can control and manage.</span></span> <span data-ttu-id="2a1f6-578">Hızlı oluştur seçeneği, tamamlanan web uygulaması için Windows Azure Web sitesinden portalın dışında dağıtmanıza olanak sağlar.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-578">The Quick Create option allows you to deploy a completed web application to the Windows Azure Web Site from outside the portal.</span></span> <span data-ttu-id="2a1f6-579">Bir veritabanını ayarlamak için adımları içermez.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-579">It does not include steps for setting up a database.</span></span>

    <span data-ttu-id="2a1f6-580">![Hızlı oluşturma yöntemini kullanarak yeni bir Web sitesi oluşturma](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image66.png "hızlı oluşturma yöntemini kullanarak yeni bir Web sitesi oluşturma")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-580">![Creating a new Web Site using Quick Create](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image66.png "Creating a new Web Site using Quick Create")</span></span>

    <span data-ttu-id="2a1f6-581">*Hızlı oluşturma yöntemini kullanarak yeni bir Web sitesi oluşturma*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-581">*Creating a new Web Site using Quick Create*</span></span>
4. <span data-ttu-id="2a1f6-582">Yeni kadar bekleyin **Web sitesi** oluşturulur.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-582">Wait until the new **Web Site** is created.</span></span>
5. <span data-ttu-id="2a1f6-583">Web sitesi oluşturulduktan sonra altındaki bağlantıya tıklayın **URL** sütun.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-583">Once the Web Site is created click the link under the **URL** column.</span></span> <span data-ttu-id="2a1f6-584">Yeni Web sitesi çalışıp çalışmadığını denetleyin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-584">Check that the new Web Site is working.</span></span>

    <span data-ttu-id="2a1f6-585">![Yeni web sitesi için gözatma](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image67.png "yeni web sitesine göz atma")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-585">![Browsing to the new web site](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image67.png "Browsing to the new web site")</span></span>

    <span data-ttu-id="2a1f6-586">*Yeni web sitesine göz atma*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-586">*Browsing to the new web site*</span></span>

    <span data-ttu-id="2a1f6-587">![Web sitesi çalışan](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image68.png "çalışan Web sitesi")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-587">![Web site running](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image68.png "Web site running")</span></span>

    <span data-ttu-id="2a1f6-588">*Çalışan Web sitesi*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-588">*Web site running*</span></span>
6. <span data-ttu-id="2a1f6-589">Portala geri dönün ve web sitesi altında adına **adı** yönetim sayfaları görüntülemek için sütun.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-589">Go back to the portal and click the name of the web site under the **Name** column to display the management pages.</span></span>

    <span data-ttu-id="2a1f6-590">![Web sitesi Yönetim sayfalarının açma](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image69.png "web sitesi Yönetim sayfalarının açma")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-590">![Opening the web site management pages](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image69.png "Opening the web site management pages")</span></span>

    <span data-ttu-id="2a1f6-591">*Web Sitesi Yönetim sayfalarının açma*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-591">*Opening the Web Site management pages*</span></span>
7. <span data-ttu-id="2a1f6-592">İçinde **Pano** sayfasındaki **Hızlı Bakış** bölümünde **yayımlama profili indir** bağlantı.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-592">In the **Dashboard** page, under the **quick glance** section, click the **Download publish profile** link.</span></span>

    > [!NOTE]
    > <span data-ttu-id="2a1f6-593">*Yayımlama profilini* tüm her etkin yayımlama yöntemi için bir Windows Azure Web sitesi için bir web uygulaması yayımlamak için gereken bilgileri içerir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-593">The *publish profile* contains all of the information required to publish a web application to a Windows Azure website for each enabled publication method.</span></span> <span data-ttu-id="2a1f6-594">Yayımlama profili URL'leri, kullanıcı kimlik bilgileri ve her bir yayımlama yönteminin etkinleştirildiği uç noktalarına karşı kimlik doğrulaması yapmak ve bağlanmak için gereken veritabanı dizelerini içerir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-594">The publish profile contains the URLs, user credentials and database strings required to connect to and authenticate against each of the endpoints for which a publication method is enabled.</span></span> <span data-ttu-id="2a1f6-595">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express Web** ve **Microsoft Visual Studio 2012** okuma desteği yayımlama profillerini yapılandırma için bu programların otomatik hale getirmek için Windows Azure Web siteleri'ne yayımlama web uygulamaları.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-595">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** and **Microsoft Visual Studio 2012** support reading publish profiles to automate configuration of these programs for publishing web applications to Windows Azure websites.</span></span>

    <span data-ttu-id="2a1f6-596">![Yayımlama profili web sitesi indiriliyor](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image70.png "yayımlama profili web sitesi indiriliyor")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-596">![Downloading the web site publish profile](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image70.png "Downloading the web site publish profile")</span></span>

    <span data-ttu-id="2a1f6-597">*Yayımlama profili Web sitesi indiriliyor*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-597">*Downloading the Web Site publish profile*</span></span>
8. <span data-ttu-id="2a1f6-598">Yayımlama profili dosyasını bilinen bir konuma indirin.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-598">Download the publish profile file to a known location.</span></span> <span data-ttu-id="2a1f6-599">Daha fazla Bu alıştırmada, bu dosyayı Visual Studio'dan bir web uygulaması için bir Windows Azure Web siteleri yayımlama için nasıl kullanılacağını görürsünüz.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-599">Further in this exercise you will see how to use this file to publish a web application to a Windows Azure Web Sites from Visual Studio.</span></span>

    <span data-ttu-id="2a1f6-600">![Yayımlama profili dosyasını kaydetme](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image71.png "yayımlama profili kaydediliyor")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-600">![Saving the publish profile file](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image71.png "Saving the publish profile")</span></span>

    <span data-ttu-id="2a1f6-601">*Yayımlama profili dosyasını kaydetme*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-601">*Saving the publish profile file*</span></span>

<a id="Ex1Task2"></a>

<a id="Task_2_-_Configuring_the_Database_Server"></a>
#### <a name="task-2---configuring-the-database-server"></a><span data-ttu-id="2a1f6-602">Görev 2 - veritabanı sunucusunu yapılandırma</span><span class="sxs-lookup"><span data-stu-id="2a1f6-602">Task 2 - Configuring the Database Server</span></span>

<span data-ttu-id="2a1f6-603">Uygulamanızı kullanan SQL Server'ın yaparsa veritabanlarını bir SQL veritabanı sunucusu oluşturmanız gerekir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-603">If your application makes use of SQL Server databases you will need to create a SQL Database server.</span></span> <span data-ttu-id="2a1f6-604">SQL Server kullanmayan basit bir uygulama dağıtmak istiyorsanız bu görevi atla.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-604">If you want to deploy a simple application that does not use SQL Server you might skip this task.</span></span>

1. <span data-ttu-id="2a1f6-605">SQL veritabanı sunucusu, uygulama veritabanını depolamak için gerekir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-605">You will need a SQL Database server for storing the application database.</span></span> <span data-ttu-id="2a1f6-606">SQL veritabanı sunucularını, aboneliğinizde Windows Azure Yönetim Portalı'nda görüntüleyebilirsiniz **Sql veritabanları** | **sunucuları** | **sunucunun Pano**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-606">You can view the SQL Database servers from your subscription in the Windows Azure Management portal at **Sql Databases** | **Servers** | **Server's Dashboard**.</span></span> <span data-ttu-id="2a1f6-607">Oluşturulan server yoksa kullanarak bir tane oluşturabilirsiniz **Ekle** komut çubuğunda düğme.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-607">If you do not have a server created, you can create one using the **Add** button on the command bar.</span></span> <span data-ttu-id="2a1f6-608">Not **sunucu adı ve URL, yönetici oturum açma adı ve parola**, sonraki görevleri kullanacağınız.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-608">Take note of the **server name and URL, administrator login name and password**, as you will use them in the next tasks.</span></span> <span data-ttu-id="2a1f6-609">Daha sonraki bir aşamasında oluşturulacak şekilde veritabanı henüz oluşturmayın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-609">Do not create the database yet, as it will be created in a later stage.</span></span>

    <span data-ttu-id="2a1f6-610">![SQL veritabanı sunucu Panosu](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image72.png "SQL veritabanı sunucu Panosu")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-610">![SQL Database Server Dashboard](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image72.png "SQL Database Server Dashboard")</span></span>

    <span data-ttu-id="2a1f6-611">*SQL veritabanı sunucu Panosu*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-611">*SQL Database Server Dashboard*</span></span>
2. <span data-ttu-id="2a1f6-612">İşlemin sonraki görev ihtiyacınız sunucunun listesinde yerel IP adresinizi eklemek, bu nedenle Visual Studio'dan veritabanı bağlantısını test eder **izin verilen IP adresleri**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-612">In the next task you will test the database connection from Visual Studio, for that reason you need to include your local IP address in the server's list of **Allowed IP Addresses**.</span></span> <span data-ttu-id="2a1f6-613">Bunu yapmanın tıklatın **yapılandırma**, IP adresi seçin **geçerli istemci IP adresi** ve yapıştırın **başlangıç IP adresi** ve **bitiş IP adresi** metin kutuları.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-613">To do that, click **Configure**, select the IP address from **Current Client IP Address** and paste it on the **Start IP Address** and **End IP Address** text boxes.</span></span> <span data-ttu-id="2a1f6-614">Kural için bir ad girin ve tıklayın ![add-client-ip-address-ok-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image73.png) düğmesi.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-614">Enter a name for the rule and click the ![add-client-ip-address-ok-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image73.png) button.</span></span>

    ![İstemci IP adresi ekleme](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image74.png)

    <span data-ttu-id="2a1f6-616">*İstemci IP adresi ekleme*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-616">*Adding Client IP Address*</span></span>
3. <span data-ttu-id="2a1f6-617">Bir kez **istemci IP adresi** için izin verilen IP adreslerini eklenir listesinde, tıklayın **Kaydet** değişiklikleri onaylamak için.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-617">Once the **Client IP Address** is added to the allowed IP addresses list, click on **Save** to confirm the changes.</span></span>

    ![Değişiklikleri onaylayın](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image75.png)

    <span data-ttu-id="2a1f6-619">*Değişiklikleri onaylayın*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-619">*Confirm Changes*</span></span>

<a id="Ex1Task3"></a>

<a id="Task_3_-_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
#### <a name="task-3---publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="2a1f6-620">Görev 3 - bir ASP.NET MVC 4 Web dağıtımı kullanarak uygulama yayımlama</span><span class="sxs-lookup"><span data-stu-id="2a1f6-620">Task 3 - Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

1. <span data-ttu-id="2a1f6-621">ASP.NET MVC 4 çözüme geri dönün.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-621">Go back to the ASP.NET MVC 4 solution.</span></span> <span data-ttu-id="2a1f6-622">İçinde **Çözüm Gezgini**, web sitesi projesini sağ tıklatın ve seçin **Yayımla**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-622">In the **Solution Explorer**, right-click the web site project and select **Publish**.</span></span>

    <span data-ttu-id="2a1f6-623">![Uygulama yayımlama](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image76.png "uygulama yayımlama")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-623">![Publishing the Application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image76.png "Publishing the Application")</span></span>

    <span data-ttu-id="2a1f6-624">*Web sitesi yayımlama*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-624">*Publishing the web site*</span></span>
2. <span data-ttu-id="2a1f6-625">İlk görevde kaydettiğiniz yayımlama profilini içeri aktarın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-625">Import the publish profile you saved in the first task.</span></span>

    <span data-ttu-id="2a1f6-626">![Yayımlama profilini içeri aktarma](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image77.png "yayımlama profilini içeri aktarma")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-626">![Importing the publish profile](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image77.png "Importing the publish profile")</span></span>

    <span data-ttu-id="2a1f6-627">*Yayımlama profilini içeri aktarma*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-627">*Importing publish profile*</span></span>
3. <span data-ttu-id="2a1f6-628">Tıklayın **bağlantısını doğrulama**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-628">Click **Validate Connection**.</span></span> <span data-ttu-id="2a1f6-629">Doğrulama tamamlandıktan sonra tıklayın **sonraki**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-629">Once Validation is complete click **Next**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="2a1f6-630">Bağlantıyı doğrula düğmesi yanında görünür yeşil bir onay işareti gördükten sonra doğrulama tamamlanır.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-630">Validation is complete once you see a green checkmark appear next to the Validate Connection button.</span></span>

    <span data-ttu-id="2a1f6-631">![Bağlantı doğrulama](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image78.png "bağlantısı doğrulanıyor")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-631">![Validating connection](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image78.png "Validating connection")</span></span>

    <span data-ttu-id="2a1f6-632">*Bağlantı doğrulama*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-632">*Validating connection*</span></span>
4. <span data-ttu-id="2a1f6-633">İçinde **ayarları** sayfasındaki **veritabanları** bölümünde, veritabanı bağlantının metin kutusunun yanındaki düğmeye tıklayın (yani **DefaultConnection**).</span><span class="sxs-lookup"><span data-stu-id="2a1f6-633">In the **Settings** page, under the **Databases** section, click the button next to your database connection's textbox (i.e. **DefaultConnection**).</span></span>

    <span data-ttu-id="2a1f6-634">![Web dağıtımı yapılandırma](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image79.png "Web dağıtımı yapılandırma")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-634">![Web deploy configuration](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image79.png "Web deploy configuration")</span></span>

    <span data-ttu-id="2a1f6-635">*Web dağıtımı yapılandırma*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-635">*Web deploy configuration*</span></span>
5. <span data-ttu-id="2a1f6-636">Veritabanı bağlantısı aşağıdaki gibi yapılandırın:</span><span class="sxs-lookup"><span data-stu-id="2a1f6-636">Configure the database connection as follows:</span></span>

   - <span data-ttu-id="2a1f6-637">İçinde **sunucu adı** , SQL veritabanı sunucu URL'sini kullanarak yazın *tcp:* önek.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-637">In the **Server name** type your SQL Database server URL using the *tcp:* prefix.</span></span>
   - <span data-ttu-id="2a1f6-638">İçinde **kullanıcı adı** , Sunucu Yöneticisi oturum açma adı yazın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-638">In **User name** type your server administrator login name.</span></span>
   - <span data-ttu-id="2a1f6-639">İçinde **parola** Sunucu Yöneticisi oturum açma parolanızı yazın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-639">In **Password** type your server administrator login password.</span></span>
   - <span data-ttu-id="2a1f6-640">Örneğin, yeni bir veritabanı adı yazın: *MVC4SampleDB*.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-640">Type a new database name, for example: *MVC4SampleDB*.</span></span>

     <span data-ttu-id="2a1f6-641">![Hedef bağlantı dizesi yapılandırma](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image80.png "hedef bağlantı dizesini yapılandırma")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-641">![Configuring destination connection string](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image80.png "Configuring destination connection string")</span></span>

     <span data-ttu-id="2a1f6-642">*Hedef bağlantı dizesini yapılandırma*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-642">*Configuring destination connection string*</span></span>
6. <span data-ttu-id="2a1f6-643">Sonra **Tamam**'a tıklayın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-643">Then click **OK**.</span></span> <span data-ttu-id="2a1f6-644">Veritabanı oluşturmak isteyip istemediğiniz sorulduğunda **Evet**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-644">When prompted to create the database click **Yes**.</span></span>

    <span data-ttu-id="2a1f6-645">![Veritabanı oluşturma](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image81.png "veritabanı dizesi oluşturma")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-645">![Creating the database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image81.png "Creating the database string")</span></span>

    <span data-ttu-id="2a1f6-646">*Veritabanı oluşturma*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-646">*Creating the database*</span></span>
7. <span data-ttu-id="2a1f6-647">Windows Azure SQL veritabanına bağlanmak için kullanacağı bağlantı dizesini, varsayılan bağlantı metin kutusu içinde gösterilir.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-647">The connection string you will use to connect to SQL Database in Windows Azure is shown within Default Connection textbox.</span></span> <span data-ttu-id="2a1f6-648">Sonra **İleri**'ye tıklayın.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-648">Then click **Next**.</span></span>

    <span data-ttu-id="2a1f6-649">![SQL veritabanı'na işaret eden bağlantı dizesi](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image82.png "SQL veritabanına işaret eden bağlantı dizesi")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-649">![Connection string pointing to SQL Database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image82.png "Connection string pointing to SQL Database")</span></span>

    <span data-ttu-id="2a1f6-650">*SQL veritabanı'na işaret eden bağlantı dizesi*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-650">*Connection string pointing to SQL Database*</span></span>
8. <span data-ttu-id="2a1f6-651">İçinde **Önizleme** sayfasında **Yayımla**.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-651">In the **Preview** page, click **Publish**.</span></span>

    <span data-ttu-id="2a1f6-652">![Web uygulaması yayımlama](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image83.png "web uygulaması yayımlama")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-652">![Publishing the web application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image83.png "Publishing the web application")</span></span>

    <span data-ttu-id="2a1f6-653">*Web uygulaması yayımlama*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-653">*Publishing the web application*</span></span>
9. <span data-ttu-id="2a1f6-654">Yayımlama işlemi tamamlandıktan sonra varsayılan tarayıcınız yayımlanan web sitesi açılır.</span><span class="sxs-lookup"><span data-stu-id="2a1f6-654">Once the publishing process finishes, your default browser will open the published web site.</span></span>

    <span data-ttu-id="2a1f6-655">![Uygulama Windows Azure'da yayımlanan](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image84.png "uygulama yayımlanan Windows Azure'a")</span><span class="sxs-lookup"><span data-stu-id="2a1f6-655">![Application published to Windows Azure](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image84.png "Application published to Windows Azure")</span></span>

    <span data-ttu-id="2a1f6-656">*Windows Azure'da yayımlanan uygulama*</span><span class="sxs-lookup"><span data-stu-id="2a1f6-656">*Application published to Windows Azure*</span></span>
