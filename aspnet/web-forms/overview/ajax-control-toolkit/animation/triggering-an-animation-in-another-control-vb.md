...
[![A düğmenin fare tıklatın panelinde animasyonun başlar](triggering-an-animation-in-another-control-vb/_static/image2.png)](triggering-an-animation-in-another-control-vb/_static/image1.png)
